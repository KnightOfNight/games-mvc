    ...
    def _seed_items(self):
        ...
        items = [
            ...
            },
            {
                ...
                'takes_durability_loss': True,
                'durability_table': WEAPON_DUR,
                'primary_stats': [{'stat': 'dex', 'base': 1.0, 'factor': 3.0}],
                'secondary_stat_pool': [
                    {'stat': 'str', 'base': 0.325, 'factor': 0.975},
                    {'stat': 'crit_chance', 'base': 1.0, 'factor': 0.3},
                    {'stat': 'bleed_factor', 'base': 0.4375, 'factor': 0.2625},
                    {'stat': 'poison_factor', 'base': 0.4375, 'factor': 0.2625},
                ],
            ...
            },
            {
                ...
                'secondary_stat_pool': [
                    {'stat': 'crit_chance', 'base': 0.5, 'factor': 0.2},
                    {'stat': 'electric_damage_bonus', 'base': 0.175, 'factor': 0.525},
            ...
            },
            {
                ...
                'takes_durability_loss': True,
                'durability_table': WEAPON_DUR,
                'primary_stats': [{'stat': 'int', 'base': 1.3, 'factor': 3.9}],
                'secondary_stat_pool': [
                    {'stat': 'wis', 'base': 0.375, 'factor': 1.125},
                    {'stat': 'spell_damage_bonus', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'mana_regen', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'primary_stats': [{'stat': 'str', 'base': 1.0, 'factor': 3.0}],
                'secondary_stat_pool': [
                    {'stat': 'end', 'base': 0.35, 'factor': 1.05},
                    {'stat': 'stun_factor', 'base': 0.4375, 'factor': 0.2625},
                    {'stat': 'physical_resist', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'takes_durability_loss': True,
                'durability_table': WEAPON_DUR,
                'primary_stats': [{'stat': 'str', 'base': 1.3, 'factor': 3.9}],
                'secondary_stat_pool': [
                    {'stat': 'dex', 'base': 0.375, 'factor': 1.125},
                    {'stat': 'crit_chance', 'base': 0.5, 'factor': 0.2},
                    {'stat': 'bleed_factor', 'base': 0.4375, 'factor': 0.2625},
            ...
            },
            {
                ...
                'secondary_stat_pool': [
                    {'stat': 'crit_chance', 'base': 1.0, 'factor': 0.3},
                    {'stat': 'bleed_factor', 'base': 0.6875, 'factor': 0.4125},
                    {'stat': 'end', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            # Armor
            {
                ...
                'primary_stats': [{'stat': 'end', 'base': 1.0, 'factor': 3.0}],
                'secondary_stat_pool': [
                    {'stat': 'str', 'base': 0.325, 'factor': 0.975},
                    {'stat': 'dex', 'base': 0.325, 'factor': 0.975},
                    {'stat': 'physical_resist', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'durability_table': ARMOR_DUR,
                'primary_stats': [
                    {'stat': 'end', 'base': 1.0, 'factor': 3.0},
                    {'stat': 'per', 'base': 0.35, 'factor': 1.05},
                ],
                'secondary_stat_pool': [
                    {'stat': 'physical_resist', 'base': 0.275, 'factor': 0.825},
                    {'stat': 'radiation_resist', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'dex', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'takes_durability_loss': True,
                'durability_table': ARMOR_DUR,
                'primary_stats': [{'stat': 'end', 'base': 0.675, 'factor': 2.025}],
                'secondary_stat_pool': [
                    {'stat': 'per', 'base': 0.35, 'factor': 1.05},
                    {'stat': 'physical_resist', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'int', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'secondary_stat_pool': [
                    {'stat': 'dex', 'base': 0.35, 'factor': 1.05},
                    {'stat': 'crit_chance', 'base': 0.5, 'factor': 0.2},
                    {'stat': 'str', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'secondary_stat_pool': [
                    {'stat': 'str', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'end', 'base': 0.325, 'factor': 0.975},
                    {'stat': 'physical_resist', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'primary_stats': [{'stat': 'end', 'base': 1.0, 'factor': 3.0}],
                'secondary_stat_pool': [
                    {'stat': 'physical_resist', 'base': 0.35, 'factor': 1.05},
                    {'stat': 'str', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'magic_resist', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            # (rounded down), per the brief's firm anchor-and-scale directive.
            {
                ...
                'takes_durability_loss': True,
                'durability_table': WEAPON_DUR,
                'primary_stats': [{'stat': 'str', 'base': 0.6, 'factor': 1.8}],
                'secondary_stat_pool': [],
                'description': (
            ...
            },
            {
                ...
                'takes_durability_loss': True,
                'durability_table': ARMOR_DUR,
                'primary_stats': [{'stat': 'end', 'base': 0.4, 'factor': 1.2}],
                'secondary_stat_pool': [],
                'description': (
            ...
            },
            {
                ...
                'takes_durability_loss': True,
                'durability_table': ARMOR_DUR,
                'primary_stats': [{'stat': 'end', 'base': 0.6, 'factor': 1.8}],
                'secondary_stat_pool': [],
                'description': (
            ...
            # drop-quality). base_value = 3x price (Part 3's directive).
            {
                ...
                'takes_durability_loss': True,
                'durability_table': WEAPON_DUR,
                'primary_stats': [{'stat': 'str', 'base': 0.9, 'factor': 2.7}],
                'secondary_stat_pool': [
                    {'stat': 'dex', 'base': 0.375, 'factor': 1.125},
                    {'stat': 'crit_chance', 'base': 0.5, 'factor': 0.2},
                    {'stat': 'bleed_factor', 'base': 0.25, 'factor': 0.15},
            ...
            },
            {
                ...
                'takes_durability_loss': True,
                'durability_table': ARMOR_DUR,
                'primary_stats': [{'stat': 'end', 'base': 0.9, 'factor': 2.7}],
                'secondary_stat_pool': [
                    {'stat': 'physical_resist', 'base': 0.35, 'factor': 1.05},
                    {'stat': 'str', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'magic_resist', 'base': 0.175, 'factor': 0.525},
            ...
            },
            {
                ...
                'durability_table': RANGED_DUR,
                'primary_stats': [
                    {'stat': 'dex', 'base': 0.625, 'factor': 1.875},
                    {'stat': 'per', 'base': 0.625, 'factor': 1.875},
                ],
                'secondary_stat_pool': [
                    {'stat': 'crit_chance', 'base': 0.8, 'factor': 0.3},
                    {'stat': 'per', 'base': 0.35, 'factor': 1.05},
        ...
        accessories = [
            ...
            },
            {
                ...
                'takes_durability_loss': False,
                'durability_table': [],
                'primary_stats': [{'stat': 'dex', 'base': 0.7, 'factor': 2.1}],
                'secondary_stat_pool': [
                    {'stat': 'str', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'per', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'takes_durability_loss': False,
                'durability_table': [],
                'primary_stats': [{'stat': 'end', 'base': 0.7, 'factor': 2.1}],
                'secondary_stat_pool': [
                    {'stat': 'str', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'wis', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'takes_durability_loss': False,
                'durability_table': [],
                'primary_stats': [{'stat': 'int', 'base': 0.7, 'factor': 2.1}],
                'secondary_stat_pool': [
                    {'stat': 'wis', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'dex', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'takes_durability_loss': False,
                'durability_table': [],
                'primary_stats': [{'stat': 'wis', 'base': 0.7, 'factor': 2.1}],
                'secondary_stat_pool': [
                    {'stat': 'int', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'end', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            },
            {
                ...
                'takes_durability_loss': False,
                'durability_table': [],
                'primary_stats': [{'stat': 'per', 'base': 0.7, 'factor': 2.1}],
                'secondary_stat_pool': [
                    {'stat': 'dex', 'base': 0.175, 'factor': 0.525},
                    {'stat': 'int', 'base': 0.175, 'factor': 0.525},
                ],
            ...
            # (Part 2's kit-wide directive).
            {
                ...
                'takes_durability_loss': True,
                'durability_table': ARMOR_DUR,
                'primary_stats': [{'stat': 'str', 'base': 0.4, 'factor': 1.2}],
                'secondary_stat_pool': [],
                'description': (
