...
| 18 | Animal Hides Don't Stack in Inventory | bug |  | 2026-07-12 |
| 19 | Automatic command completion |  |  | 2026-07-12 |
| 20 | Command 'loot all' throws hidden unhandled exception and disconnects player websocket | bug | Version 20 | 2026-07-12 |
| 21 | New command: sell all |  |  | 2026-07-12 |
| 22 | Command nouns and verbs: allow better item references, allow plural references |  |  | 2026-07-12 |
| 23 | Leaving a room by cardinal direction command does not end combat like 'flee' does. | bug |  | 2026-07-12 |
| 24 | NPC display grammar: article stacking in combat messages |  |  | 2026-07-12 |
...
| 28 | Corpse decay and empty-loot messaging is noisy and misleading |  |  | 2026-07-12 |
| 29 | Block looting (and related inventory commands) during combat |  |  | 2026-07-12 |
| 30 | Travel network: should checkpoints (shards) also be travel senders? |  |  | 2026-07-12 |
| 31 | Shyland: richer live connection status indicator (beyond static "Connected to Shyland") |  |  | 2026-07-12 |
...
| 35 | Map system backend: MapFrag derivation, exit boundary flags, map data payload |  | Version 20 | 2026-07-12 |
| 36 | Map system client: right-pane map rendering (node-and-line, fog-of-war) |  | Version 20 | 2026-07-12 |
