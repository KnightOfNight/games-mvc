...
| sudo-color | `#E24B4A` | **a bot's talking color (v25.5, #281, pending implementation):** sudo's out-of-world voice — error-color's hex under its own separable name (deliberate reuse, the error/agro pattern). Bots talk in their talking color; their effects wear the world's standard colors (Section 10.11) |
