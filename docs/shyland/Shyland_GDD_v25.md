...
| MC — the Monitoring half (#33, #37) | Universal event capture: every command, every output, every event through creation-level taps into the MC sink (Section 10.11). sudo (#262) is its first live listener — the sudo bot (v25.6, pending implementation). |
