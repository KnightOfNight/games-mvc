...
| 17 | New NPC Spawn Doesn't Agro Immediately | KnightOfNight | bug, B2 | Version 21 | 2026-07-16 |
...
| 29 | Block looting (and related inventory commands) during combat | KnightOfNight |  |  | 2026-07-13 |
| 30 | Travel network: should checkpoints (shards) also be travel senders? | KnightOfNight |  |  | 2026-07-12 |
...
| 38 | Obelisk attunement: player-set home spawn at checkpoint shards | KnightOfNight |  |  | 2026-07-12 |
...
| 41 | Lock battle-zone access until a new player has visited all of The Convergence | KnightOfNight |  | Version 22 | 2026-07-16 |
| 47 | Right pane: player effects display (sent and received) | KnightOfNight |  |  | 2026-07-13 |
| 52 | In-combat heals apply on stale character state, resurrecting persisted damage (lost-update race) | KnightOfNight | bug, B2 | Version 21 | 2026-07-16 |
| 54 | consider how to simplify combat language and make it more human | KnightOfNight |  |  | 2026-07-14 |
| 55 | "who's here" list doesn't need "is here" at the end of every line | KnightOfNight | bug, B1 | Version 21 | 2026-07-16 |
| 57 | new command: home [now] | KnightOfNight |  |  | 2026-07-14 |
| 58 | vendor for-sale list changes | KnightOfNight |  |  | 2026-07-15 |
| 59 | some commands not logged in timestamped output | KnightOfNight | bug |  | 2026-07-15 |
| 60 | change flag "Droppable" to "Unbound" | KnightOfNight | B1 | Version 21 | 2026-07-16 |
| 61 | refuse to use a healing draught if player vitality is full | KnightOfNight |  |  | 2026-07-15 |
| 64 | Unify NPC ordering: targeting order, N.noun index, and ordinal labels disagree | KnightOfNight | bug, B2 | Version 21 | 2026-07-16 |
| 65 | 'use 3 heal' responds with 'You can't use everything at once.' | KnightOfNight |  | Version 22 | 2026-07-16 |
| 66 | Balance: the Whistler Below is a difficulty cliff — contest scale doubles at boss #2 | KnightOfNight | B3 | Version 21 | 2026-07-16 |
| 67 | tab completion doesn't work for 'equip' | KnightOfNight |  |  | 2026-07-15 |
| 68 | broadsword has a lifesteal value of zero | KnightOfNight | bug, B3 | Version 21 | 2026-07-16 |
| 70 | Feature: Longevity has no drain — the slow-burn design needs its first consuming mechanic | KnightOfNight |  |  | 2026-07-15 |
| 75 | repair all should retry, not need multiple manual tries | KnightOfNight |  |  | 2026-07-15 |
| 76 | inv should take filters like buy or sell | KnightOfNight | stub |  | 2026-07-16 |
| 80 | Design: item identification visibility — knowledge by holding | KnightOfNight |  |  | 2026-07-16 |
| 81 | we need to adjust what a player sees for room description when entering an agro room | KnightOfNight | B1 | Version 21 | 2026-07-16 |
| 82 | map changes | KnightOfNight | B1 | Version 22 | 2026-07-16 |
| 84 | player help fixes | KnightOfNight | bug, B1 | Version 21 | 2026-07-16 |
| 85 | make the pane borders match the HR in style and color | KnightOfNight | B1 | Version 21 | 2026-07-16 |
| 86 | Colorize area and room description prose to match the location bar | KnightOfNight | B1 | Version 21 | 2026-07-16 |
| 88 | new command: last | KnightOfNight | stub |  | 2026-07-16 |
| 89 | Survey: kill-feasibility audit of all seeded NPC tiers (contest scale and HP vs. attainable player capability) | KnightOfNight | B3 | Version 21 | 2026-07-16 |
| 90 | 'inv' and output changes | KnightOfNight | B1 | Version 21 | 2026-07-16 |
| 91 | 'stats' output changes | KnightOfNight | B1 | Version 21 | 2026-07-16 |
| 92 | 'wallet' output changes | KnightOfNight | B1 | Version 21 | 2026-07-16 |
...
- Assignees: none
- Created: 2026-07-11 | Updated: 2026-07-16
- Blocked by: none
- Blocks: none
...
- Assignees: KnightOfNight
- Created: 2026-07-12 | Updated: 2026-07-16
- Blocked by: none
- Blocks: none
...
- Milestone: Version 21
- Assignees: KnightOfNight
- Created: 2026-07-14 | Updated: 2026-07-16
- Blocked by: none
- Blocks: none
...
## Issue #60: change flag "Droppable" to "Unbound"
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/60

### Body

if item in player inventory, Droppable should be Unbound
...
## Issue #64: Unify NPC ordering: targeting order, N.noun index, and ordinal labels disagree
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/64

### Body

## Symptom

Found in v20 Brief 3 playtesting, deferred to Version 21 by ruling (2026-07-15). With two identical NPCs in a room, `k bear` engaged "the second black bear" while the subsequent `k 2.bear` engaged "the first" — the resolver's default pick order and the ordering that ordinal labels are computed from disagree (one inverted relative to the other):

    Who's here?
    black bear is here.
    black bear is here.
    [10:12:15.52] You move to attack the second black bear!
    [10:12:19.52] You move to attack the first black bear!

## Ruled fix direction (design chat, 2026-07-15)

ONE authoritative order everywhere: the Who's-here listing, the resolver's default pick, the N.noun index, and the ordinal words in messages all use the same stable order (oldest/spawn order ascending). Under this rule, bare `k bear` engages the FIRST bear and the messages say so.

## Related polish (same issue, v21 design pass decides scope/split)

While duplicates of an NPC name are present in a fight, messages referencing them are currently indistinguishable ("The black bear misses you." twice, from different bears). Ordinal consistency in combat messages ("The first black bear misses you.") is the natural companion fix; it overlaps the #24 display-helper machinery landing in v20's output & messaging brief, so design it against that helper.

## Provenance

Bug predates none of v20's mechanics changes in effect (targeting worked, kills landed); it is an ordering-consistency defect. Deferred intact — including the core inversion — per the version cadence rule: odd versions are for fixes and refinements.


### Comments (1)

**KnightOfNight** — 2026-07-15:
Implementation-level diagnosis (from the Brief 3 Amendment 1 CC session, 2026-07-15, recorded from the design chat): the resolver already picks NPCs oldest-first — its per-verb selection sorts on (spawned_at, pk) — so the inversion likely lives in npc_display_name computing ordinals from an UNORDERED get_live_npcs_in_room queryset, versus the resolver's age sort. If confirmed, the core fix is ordering that queryset canonically on (spawned_at, pk) so both universes agree; the ruled 'one authoritative order everywhere' then holds by construction. The v21 design pass should verify this and design the companion ordinal-in-messages polish against the #24 display helper (which lands in v20 Brief 5).
...
## Issue #66: Balance: the Whistler Below is a difficulty cliff — contest scale doubles at boss #2
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/66

### Body

## Symptom

v20 playtest (2026-07-15): the Whistler Below fight produces chronic misses even for a level 8 character (STR/DEX 25/25) — well above the Whistling Sink's target band. Operator verdict: "hard = I miss a lot." The felt difficulty is whiff-frustration, which is the contest scale talking, not the HP.

## The data (seeded boss ladder, HP / contest scale)

| # | Boss | HP | Scale | Step from previous |
|---|---|---|---|---|
| 1 | Silk Matron | 120 | 3.0 | — |
| 2 | Whistler Below | 260 | 6.0 | HP x2.17, scale x2.0 |
| 3 | Dronemother | 320 | 6.0 | x1.23 / x1.0 |
| 4 | Undercrag Weaver | 500 | 9.0 | x1.56 / x1.5 |
| 5 | Chittering King | 650 | 10.0 | x1.3 / x1.11 |
| 6 | Crowned Devourer | 850 | 10.0 | x1.3 / x1.0 |

Every ladder step is a x1.2–1.6 increment EXCEPT Matron->Whistler, which doubles both dimensions at once; the Whistler's scale equals boss #3's. Escort compounds it: two gated Whistler's-young at 50 HP / scale 4.0 — double the Matron's brood (25 / 2.0) in both dimensions. Under the v19 additive contest math, scale governs whether swings land at all.

## Ruled retune direction (final numbers reserved for the v21 design pass — balance is explicit-review territory)

Scale first: Whistler ~4.5–5.0; young ~3.0. HP second: Whistler ~210 (restoring a smooth 120 -> ~210 -> 320 ladder). Young HP fine at 50. Loot cache, death staging, and spawn gating untouched — numbers-only.
...
## Issue #68: broadsword has a lifesteal value of zero
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/68

### Body

Broadsword Mk 1  — 100% durability  [Uncommon, Droppable]
  A long, wide blade that wants both hands. Steady and unhurried.
...
**Classification: design miss in the stat-roll math, not data corruption.** The stored value `0` is exactly what the code deterministically produces for lifesteal on any Mk 1 item — every Mk 1–2 lifesteal roll is 0, at **every** rarity. No code changes made; fix to be ruled in the design chat.

### Root cause

`item_utils._roll_stat()` rounds every stat roll to an integer:
...
The Broadsword's pool (seed_world.py) authors lifesteal at `base 0.2, factor 0.1`. For this item (Mk 1, Uncommon, spread 0.90–1.05):

- midpoint = 0.2 + 0.1×1 = **0.3**
- roll = uniform(0.27, 0.315) → `round()` → **always 0**

Even Legendary tops out at 0.3 × 1.20 = 0.36 → still 0. Lifesteal cannot roll nonzero until Mk 3 (and only sometimes); it is guaranteed ≥1 only from Mk 4 up.

### The zero roll also wastes the item's only secondary slot

`generate_item_instance()` draws the secondary stat **before** rolling its value. Uncommon gets exactly 1 secondary slot; when lifesteal is drawn (25% chance on this pool), that slot is consumed by a guaranteed-zero stat — the item is strictly worse than a sibling that drew DEX or crit_chance. The zero entry is then stored in `rolled_secondary_stats` and the examine display prints all stored entries verbatim, hence `Lifesteal: 0`.

### Scope — all affected definitions

Every pool entry with midpoint < 0.5 at Mk 1 has the same guaranteed-zero behavior (all are `base ≤ 0.3, factor 0.1`):

| Stat | Items | Mk 1 midpoint |
|---|---|---|
| `lifesteal` (0.2/0.1) | Iron Sword, Broadsword, Iron Shortsword | 0.3 — zero through Mk 2 |
| `poison_chance` (0.3/0.1) | Combat Knife | 0.4 — zero through Mk 1 |
| `electric_damage_bonus` (0.3/0.1) | Pulse Pistol | 0.4 — zero through Mk 1 |
| `mana_regen` (0.3/0.1) | Apprentice Staff | 0.4 — zero through Mk 1 |

(`crit_chance`/`bleed_chance`/`stun_chance` at 0.5/0.2 clear the rounding threshold at Mk 1 and are fine.)

Reproduction is not limited to playtest stock: loot drops (`generate_loot_from_table`), vendor `buy`, and the playtest skill all go through the same `generate_item_instance()`, so real drops roll these zeros too.

### Mitigating context

None of the proc secondary stats (lifesteal, crit_chance, bleed_chance, poison_chance, …) are consumed by combat yet — combat reads only character `stat_str`/`stat_dex` and the weapon's damage roll. Rolled secondaries are currently display-only, so there is no gameplay corruption today; the defect is a dead stat line and a wasted rarity slot.

### Design questions to rule (design chat)

1. **Units/semantics of proc stats** — are lifesteal/poison_chance/etc. integer percentage points? If they were meant to be fractional (e.g. 0.3%), integer rounding is the wrong resolution and the roll/display need finer units.
2. **How to fix the zero rolls** — options: raise base/factor so Mk 1 midpoints clear ~0.56 (guaranteed ≥1 at all rarities); floor proc-stat rolls at 1; re-draw the pool when a roll rounds to 0; or gate low-midpoint stats out of low-Mk pools.
3. **Display rule** — should a zero-value stat ever print? (Suppressing it hides the symptom but keeps the wasted slot.)
4. **Data cleanup** — existing `ItemInstance` rows already carry zero-value entries in `rolled_secondary_stats`; whichever fix is ruled, decide whether to re-roll, strip, or leave them.
...
## Issue #76: inv should take filters like buy or sell
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/76
...
## Issue #81: we need to adjust what a player sees for room description when entering an agro room
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/81

### Body

the description doesn't clear; it stays the same as the previous room.

the location bar updates.

I am thinking we should just make entering an agro room handle showing room details the same as any other room.


### Comments (1)

**KnightOfNight** — 2026-07-16:
V21 triage findings and rulings (design chat, 2026-07-16):

**Diagnosis (code inspection).** The description doesn't "fail to clear" — the aggro arrival branch never renders the room at all. Both arrival paths skip `send_room_description` entirely when the destination has aggro: cardinal movement (`consumers.py` ~line 475) and flee-into-aggro (~line 1741) go straight to snarl lines + `start_combat` + fight panel. The location bar updates because the status refresh still fires; the map is unaffected because the v20 RoomVisit-at-arrival amendment (#50) already decoupled fog-of-war from rendering.

**Ruled fix direction.** Entering an aggro room renders the room exactly like any other entry, in BOTH paths (movement and flee). Ordering: full room render first (pane clear, area/room prose, exits, who's-here — which lists the attackers), then the snarl lines, then combat engagement (fight panel + combat-red status). The ambush reads as: you see the room, and it sees you.

**Grammar ride-along (same fix).** Snarl lines currently render with introductions ("A cave centipede snarls and moves to attack!"). Once the room render's who's-here section has introduced the NPC, the snarl is a second mention and takes the definite article ("The cave centipede snarls and moves to attack!") — flip the `introduction` flag at both snarl call sites as part of this fix.

**Implementation note.** `send_room_description` ends by sending a status payload; the combat engagement also refreshes status. The fix brief should sequence these so combat-red state lands last and nothing double-sends confusingly — implementation detail, decided in the fix brief.


## Issue #82: map changes
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/82
...
colorize U or D depending on discovered (the room behind it) or not

colorize gate icon depending on discovered (the room behind it) or not

red circles if room is agro (has any agro NPCs configured to spawn, regardless of their current state) and player has been there before

if discovered, 
make the circle a different shape if there's a shard in it

make the circle a different shape if there's a sphere in it

if not discovered, it remains a simple gray circle

### Comments (0)

None.

## Issue #84: player help fixes
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/84

### Body

command 'brief' not listed
...
should include up/down


----------------------------------


newline before the note about tab completion


-----------------------------------


more notes on every command that takes complex matching  - make this one section that can describe the handling well, and then update individual commands with something like "<item selection>" 
...
standardize spacing on things like `[item | all]` vs. `[item|all]`





these should be in key-color
...
everything else in value-color

### Comments (0)

None.

## Issue #85: make the pane borders match the HR in style and color
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/85

### Body

there is a horizontal rule or some other HTML structure in the output pane between the room description and the dynamic output.

make the borders between all the panes match the style and color

it is OK that the HR won't touch the pane border to its right.

we may have to adjust other sizes to make room for the wider borders.


### Comments (1)

**KnightOfNight** — 2026-07-16:
V21 triage rulings (design chat, 2026-07-16):

**Dynamic color — ruled.** Pane borders take the current Zone's `theme_color`, matching the room separator (#78) in style and color: 5px weight, ~0.75 opacity, updated dynamically on zone change. The color source is the same server-delivered `zone_color` the separator already rides; pre-first-render fallback matches the render payload's existing `#CCCCCC` fallback.

**Border census — all five (code inspection, `game.html`):**

1. Location bar ↔ output (`#loc-bar` border-bottom)
2. Left column ↔ right pane — the full-height vertical divider, composed of the right edges of `#loc-bar`, `#output-wrap`, and the command bar; all segments styled together so it reads as one continuous line
3. Output ↔ command bar (`#cmd-bar` border-top)
4. Stats ↔ fight panel (`#side-stats` border-bottom)
5. Fight panel ↔ map (`#map-wrap` border-top)

All five are ruled in.

**Border 4 combat interplay — ruled.** The existing `in-combat` behavior (border flips to `--combat-accent`) takes precedence while a fight is active; the zone tint returns when combat ends. The red state is information; the zone tint is ambience, and ambience yields to information.

**Implementation notes for the fix brief:**

- The body's acknowledgments stand: the room separator won't touch the pane border to its right (fine), and pane sizes may need adjustment to accommodate the wider borders.
- The responsive/mobile layout restacks single-column with a different border set; apply the same treatment to whatever borders exist in that layout — implementation detail.
- Rounded ends on the separator translate to pane borders as an implementation detail (straight borders are expected; no requirement to round them).


## Issue #86: Colorize area and room description prose to match the location bar
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/86

### Body

## Summary

In the output pane, render the area description paragraph in the Area's theme color and the room description paragraph in the location bar's room color. Today both paragraphs render as one undifferentiated block in a single fixed prose color.

## Background — this revises a prior ruling

Closed issue #1 originally ruled: "Any zone, area, or room information in the main output window will be colored the same as the breadcrumbs." Its D1 ruling comment (2026-07-13) then narrowed scope for v20: theme colors became model fields feeding the location bar, and output prose was set to a fixed near-white client style. That narrowing is what shipped.

This issue supersedes the prose-color portion of the D1 narrowing, by operator ruling (design chat, 2026-07-16). The location bar's per-segment colorization from #1 is untouched and remains correct.

## Current behavior (v20, verified by code inspection 2026-07-16)

- The consumer concatenates area prose and room prose into a single payload field: `text: f'{area_context}{description_text}'` (`consumers.py`, room-render composition). The client cannot distinguish the two levels.
- The client renders the whole block in one fixed color: `.msg-room-render { color: #B8B4A6; }` (`game.html`).
- The location bar renders zone in `zone_color`, area in `area_color`, room in fixed near-white `--loc-room: #E8E4D8`.

## Ruled direction

- Area description prose: rendered in the Area's `theme_color` — the same color as the Area segment of the location bar.
- Room description prose: rendered in the same color as the Room segment of the location bar (the fixed near-white).
- Consequence: the room-render payload must carry the area prose and room prose as separate fields (with the area color riding along, consistent with the existing pattern of server-delivered colors), instead of one concatenated string.
- Side benefit: this visually distinguishes the two prose levels, which currently stack with nothing marking where area text ends and room text begins.

## Not in scope

- Zone description display — the Zone model's `description` field remains unrendered by explicit ruling (2026-07-16): do nothing with it.
- Any change to location bar behavior.

## Notes

- v21 bucket-1 candidate (UI/UX fixes); milestone to be set during triage.
...
## Issue #89: Survey: kill-feasibility audit of all seeded NPC tiers (contest scale and HP vs. attainable player capability)
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/89

### Body

## Summary

Research spike: audit every seeded NPC — normals, elites, bosses, and boss escorts — for kill feasibility against the player capability realistically attainable at that NPC's content band. The goal is to find every remaining difficulty cliff or effectively-unkillable encounter in the data before a player finds it in play.

## Motivation

Two instances of this defect class have now been found by playtest rather than by data:

- The pre-v20 unkillable-spiders bug (found and fixed; referenced in #33's motivation).
- The Whistler Below cliff (#66): contest scale doubles at boss #2, producing chronic misses for a level 8 STR/DEX 25/25 character. Operator verdict: "hard = I miss a lot" — in practice the fight is unwinnable before consumables run out.

#66's retune covers the six-boss ladder only. The elite tier is not in its table, and a code read during triage (2026-07-16) flagged a likely third instance: the elder cave centipede (elite, Verdant Reach deep-cave rooms vr-c5c/f) carries contest scale 8.0 — higher than the Whistler's 6.0 and equal to boss #4's territory. If 6.0 produces chronic whiffs at the target band, the elder tier at 8.0 is plausibly a second cliff.

## Scope

- Every seeded NPC definition with combat stats: normals, elites, bosses, escorts/adds (seed_world.py is the authoritative source — the code is definitive).
- For each: contest scale and HP against attainable player stats and realistic sustained DPS at the content band the NPC is placed in (zone/room placement determines the band).
- Escort compounding: where adds are gated to a boss, evaluate the combined encounter, not the boss alone (the #66 pattern — the Whistler's young double the Matron's brood in both dimensions).
- Consumable economics as a feasibility bound: a fight that outlasts a reasonable potion supply at the band is not feasible even if the math converges eventually.
- Output: a findings table (NPC, tier, placement band, scale, HP, verdict, notes), committed to docs/shyland/ as a survey report. Method notes included — this survey is the manual, one-time version of what the Firehose Logging milestone (#33/#37) will eventually answer with live data, and its method should inform that design.

## Explicitly out of scope

- Changing any numbers. Findings become issues (one per defect or coherent defect group) per the triage pipeline; fixes are ruled in the design chat and land in implementation briefs.
- The Whistler Below retune itself — that is #66's territory. If the survey's method produces refined numbers relevant to #66, record them as a comment on #66, not as scope creep here.

## Relationships

- #66 — the boss-ladder instance; this survey generalizes it across all tiers.
- #33 / #37 (Firehose Logging) — the future automated answer to this class of question; this survey's method notes feed that design.

## Notes

- Research spike — does not count against the version brief cap.
- v21 bucket-2 candidate (important gameplay fixes); milestone to be set during triage.
...
## Issue #90: 'inv' and output changes
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/90
...
```
Equipment:
  [HEAD]  Leather Cap Mk 1  — 100% durability  [Common, Bound]
  [CHEST]  Leather Vest Mk 1  — 100% durability  [Common, Bound]
  [HANDS]  Leather Gloves Mk 1  — 100% durability  [Common, Bound]
  [WAIST]  Leather Belt Mk 1  — 100% durability  [Common, Bound]
  [LEGS]  Leather Leggings Mk 1  — 100% durability  [Common, Bound]
  [FEET]  Leather Boots Mk 1  — 100% durability  [Common, Bound]
  [MAIN_HAND]  Battle Axe Mk 1  — 100% durability  [Uncommon, Bound]

Inventory (47/250 items):
  Healing Draught Mk 1 x47  [Common, Unbound]

Wallet:
  104 golds, 47 silvers

```

All headers in key-color
All results in value-color


### Comments (2)

**KnightOfNight** — 2026-07-16:
Updated to show the future version of Unbound instead of Droppable

**KnightOfNight** — 2026-07-16:
V21 triage ruling (design chat, 2026-07-16): "All results in value-color" carries one exception — the trailing status flag block keeps its existing ruled colorization (rarity colors on the rarity word, chrome color on brackets and binding flag, per the v20 #48 composition). Value-color applies to the item line up to the flag block.


## Issue #91: 'stats' output changes
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/91
...
```
[ Character Stats — Shy-Guy (Level 10) ]
  Strength     (STR): 25
  Dexterity    (DEX): 25
  Endurance    (END): 30
  Intelligence (INT): 11
  ...
  Vitality:   425 / 425
  Longevity:  345 / 345
  Acuity:     1.0 (baseline 1.0)

  XP: 8871 / 10000 (next level)
...
```
Character Stats:
  Player: Shy-Guy - Level 10 Archetype/Other-Info
...
'Character Stats:' should be key-color
Everything else value-color
...
- The Player line's "Archetype/Other-Info" placeholder is ruled: Origin + Archetype, e.g. `Player: Shy-Guy - Level 10 Feral Blade`.
- Confirmed: everything under the 'Character Stats:' header is value-color, including stat labels like "Strength (STR):". A subkey-color for interior labels was considered and explicitly deferred — do not introduce one in this issue's fix.


## Issue #92: 'wallet' output changes
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/92

### Body

current output

Wallet: 104 golds, 47 silvers

changes...

'Wallet:' in key-color

wallet contents in value-color
