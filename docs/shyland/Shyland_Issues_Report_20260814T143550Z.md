...
| 243 | Deleted-while-connected: commands that never fresh-fetch (e.g. inv) render empty/stale output instead of routing to the creator | KnightOfNight |  |  | 2026-08-14 |
