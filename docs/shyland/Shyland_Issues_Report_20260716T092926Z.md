...
| 60 | change flag "Droppable" to "Unbound" |  |  | 2026-07-15 |
| 61 | refuse to use a healing draught if player vitality is full |  |  | 2026-07-15 |
| 64 | Unify NPC ordering: targeting order, N.noun index, and ordinal labels disagree | bug | Version 21 | 2026-07-15 |
| 65 | 'use 3 heal' responds with 'You can't use everything at once.' |  | Version 21 | 2026-07-15 |
| 66 | Balance: the Whistler Below is a difficulty cliff — contest scale doubles at boss #2 |  | Version 21 | 2026-07-15 |
| 67 | tab completion doesn't work for 'equip' |  |  | 2026-07-15 |
| 68 | broadsword has a lifesteal value of zero | bug |  | 2026-07-15 |
| 70 | Feature: Longevity has no drain — the slow-burn design needs its first consuming mechanic |  |  | 2026-07-15 |
| 75 | repair all should retry, not need multiple manual tries |  |  | 2026-07-15 |
| 76 | inv should take filters like buy or sell | stub |  | 2026-07-16 |
| 80 | Design: item identification visibility — knowledge by holding |  |  | 2026-07-16 |
| 81 | we need to adjust what a player sees for room description when entering an agro room |  |  | 2026-07-16 |
| 82 | map changes |  |  | 2026-07-16 |
| 84 | player help fixes | bug |  | 2026-07-16 |
...
| # | Title | Labels | Closed |
|---|---|---|---|
| 83 | command 'brief' not listed in player help | bug | 2026-07-16 |
| 79 | NPC grammar: indefinite article on first presentation; occupant lines capitalized | bug | 2026-07-16 |
| 78 | Add a zone-colored separator between the room block and event lines |  | 2026-07-16 |
| 77 | Remove the bracketed room header from the output pane |  | 2026-07-16 |
| 28 | Corpse decay and empty-loot messaging is noisy and misleading |  | 2026-07-15 |
| 24 | NPC display grammar: article stacking in combat messages |  | 2026-07-15 |
| 15 | Show Commands in Output Window for Context |  | 2026-07-15 |
| 39 | Output colorization: section header labels ('Exits:', 'Who's here?', 'What's here?') should share one color |  | 2026-07-15 |
| 14 | Look-Command Output Sections |  | 2026-07-15 |
| 13 | Combat Messages Colors |  | 2026-07-15 |
| 74 | Bulk repair joins all lines into one message; split per-repair per the #63 ruling | bug | 2026-07-15 |
| 51 | right pane has horizontal and vertical scrollbars | bug | 2026-07-15 |
| 73 | Browser window scrollbar present at every size; app should fit the viewport exactly | bug | 2026-07-15 |
| 72 | Player stats render as plain text; make V/L bars and A a band gauge like the fight panel |  | 2026-07-15 |
| 71 | Right-pane stats header says SHYLAND instead of the character name | bug | 2026-07-15 |
| 31 | Shyland: richer live connection status indicator (beyond static "Connected to Shyland") |  | 2026-07-15 |
| 2 | Right Pane Design |  | 2026-07-15 |
| 1 | Location Bar Updates - Complete Breadcrumb Trail by Name |  | 2026-07-15 |
| 63 | Bulk sell batches all sale lines into one message; split per-sale like loot | bug | 2026-07-15 |
| 62 | loot all should sweep every corpse in the room, not one corpse |  | 2026-07-15 |
