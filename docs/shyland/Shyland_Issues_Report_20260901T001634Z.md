...
| 320 | Agent door / sudo bot has no currency-grant action — copper cannot be gifted | KnightOfNight | monitoring-and-command |  | 2026-09-01 |
...
## Issue #320: Agent door / sudo bot has no currency-grant action — copper cannot be gifted
