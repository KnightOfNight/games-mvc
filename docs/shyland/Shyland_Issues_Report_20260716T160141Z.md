...
| 52 | In-combat heals apply on stale character state, resurrecting persisted damage (lost-update race) | KnightOfNight | bug | Version 21 | 2026-07-14 |
| 53 | map gates are gray (ed out) even if they have been passed by the player | KnightOfNight | bug |  | 2026-07-14 |
...
| 64 | Unify NPC ordering: targeting order, N.noun index, and ordinal labels disagree | KnightOfNight | bug | Version 21 | 2026-07-15 |
...
| 82 | map changes | KnightOfNight |  | Version 21 | 2026-07-16 |
...
colorize U or D depending on discovered or not

colorize gate icon depending on discovered or not (maybe dupe issue)

red circles if room is agro and player has been there before
