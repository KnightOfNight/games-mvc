...
| 201 | Flame Projector / Dart Caster ship at default base_value 1 — pricing unruled | KnightOfNight | triaged, V24 | Version 24.21 | 2026-08-11 |
...
- Author: KnightOfNight
- Labels: triaged, V24
- Milestone: Version 24.21
- Assignees: KnightOfNight
- Created: 2026-08-02 | Updated: 2026-08-11
- Blocked by: none
- Blocks: none
...
Design ruling (2026-08-11, V24.21 design session): **this issue founds Version 24.21** — milestone assigned in the same motion. The 2026-08-05 ruling stands unchanged (Flame Projector `base_value` 85, Dart Caster 70; one `base_values` dict entry each in `seed_world.py`; seed rerun with expected deletions 0; production seed at the closeout tail via `make seed-prod`). The release's brief follows on branch `version_24_21`.
