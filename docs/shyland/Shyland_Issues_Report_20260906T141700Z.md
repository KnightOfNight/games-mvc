...
| 326 | sudo bot: request failures are silent to the requesting admin — operator wants a legible in-pane line whenever the bot is running | KnightOfNight |  |  | 2026-09-06 |
