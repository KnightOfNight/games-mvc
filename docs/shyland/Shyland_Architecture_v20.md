...
> Authoritative technical reference as of commit 0cad421 (v20 brief 3 + amendment 1: command grammar resolver, loot room sweep, bulk-sale message splitting, dispatch guard, combat movement block, timestamps toggle, rarity flag block, tab completion; v20 brief 2 + amendment 1: output message envelope, events-not-renderings display categorization; v20 brief 1: map system — commits 02758b2 model + verification, 9599e11 world re-lay, 4289902 map payload, 963ddf2 map client).
