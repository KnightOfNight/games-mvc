...
> Authoritative technical reference as of commit 544d2e3 (v20 brief 2: output message envelope; v20 brief 1: map system — commits 02758b2 model + verification, 9599e11 world re-lay, 4289902 map payload, 963ddf2 map client).
