...
| 35 | Map system backend: MapFrag derivation, exit boundary flags, map data payload |  | Version 20 | 2026-07-14 |
...
**KnightOfNight** — 2026-07-14:
V20 brief order LOCKED (2026-07-13), all five briefs written: 1) Map System (#43, #44, #46, #35, #36) — 2) Output Envelope (#32) — 3) Commands (#22, #3, #21, #19, #20, #23, #45, #48) — 4) UI Layout (#2, #1, #31) — 5) Output & Messaging (#13, #14, #39, #15, #24, #28). Rationale: the envelope lands early so its timestamps and ordering aid every later playtest; commands is self-contained; layout restructures the client with the map already in place; output & messaging goes last because its palette colorizes surfaces the earlier briefs create (the item flag block, the panes, the combat-red family).
