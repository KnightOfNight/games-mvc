...
| 296 | sudo inventory reports are unreadable comma prose — answer path needs a game-rendered report delivery (leader line in sudo voice + the shared inv/equip item-line rendering) | KnightOfNight | monitoring-and-command |  | 2026-08-26 |
