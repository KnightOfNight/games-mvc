...
| 302 | sudo bot: the model must never invent a value it should read from the database — make receipts structural, not behavioral | KnightOfNight | emergent |  | 2026-08-27 |
