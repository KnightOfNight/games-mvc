...
| 311 | Empty durability_table with takes_durability_loss=True: penalty lookup falls through to 1.0 — pristine items render yellow and fight fully penalized | KnightOfNight | bug |  | 2026-08-30 |
| 312 | Admin cannot re-save ItemDefinitions with legitimately-empty JSON lists: durability_table/primary_stats/secondary_stat_pool lack blank=True | KnightOfNight | bug |  | 2026-08-30 |
