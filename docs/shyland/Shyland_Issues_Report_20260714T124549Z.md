...
| 49 | Checkpoint shard wording: remaining sphere->shard fixes (Stairhead, Cragfoot, shard entity, villager lines) | bug | Version 20 | 2026-07-14 |
...
## Issue #49: Checkpoint shard wording: remaining sphere->shard fixes (Stairhead, Cragfoot, shard entity, villager lines)
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/49

### Body

## Summary

Issue #46 fixed the sphere->shard confusion at Fordwatch, but the same disease infects the other two Z01 checkpoints and the shard entity itself. Per the GDD, checkpoint obelisk lights are Verdant SHARDS; "sphere" is reserved for the two source-node objects (the Primordial Sphere at the Heart, the Verdant Sphere at the Crown). Found during the design-chat verification of v20 Brief 1 (2026-07-14).

## Known wrong (display text; exact lines in the amendment brief)

- Stairhead: brief description ("A green sphere rides the wind...") and full description ("A small sphere of green light rides the wind here...").
- Cragfoot: brief description ("A green sphere warms itself by a fire...") and full description ("A small sphere of green light hangs near the flames...").
- The checkpoint shard entity description: "A small sphere of soft green light, unattached to anything...".
- Villager/NPC description lines referring to the checkpoint light as "the sphere" (e.g. "...stayed for the sphere, which he talks to..." and the line calling the sphere "the little lamp").

## Explicitly correct — MUST NOT change

- Every reference to the Primordial Sphere (the Heart's white sphere) and the Verdant Sphere (the summit's green sphere), including "a green sphere in an obelisk" in summit-referencing dialogue and both source-node entity descriptions. These are genuinely spheres.
- Dialogue LISTENING keywords may keep 'sphere' as a synonym (players will still say it); display text is what changes.

## Fix vehicle

v20 Brief 1 Amendment 1 (world data just re-laid; enforce-exact reseed). Amendments do not count against the brief cap.
