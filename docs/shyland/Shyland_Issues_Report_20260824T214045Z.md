...
| 287 | Agent door: no item-removal action — sudo can gift but not take | KnightOfNight |  |  | 2026-08-24 |
| 288 | Agent door: no targeted equip/unequip actions — strip is all-or-nothing, dress only restores the snapshot | KnightOfNight |  |  | 2026-08-24 |
| 289 | Agent door: no mutation action — created artifacts (and items generally) cannot be edited | KnightOfNight |  |  | 2026-08-24 |
| 290 | Agent door: no room-directory query — rooms unreachable except through characters | KnightOfNight |  |  | 2026-08-24 |
