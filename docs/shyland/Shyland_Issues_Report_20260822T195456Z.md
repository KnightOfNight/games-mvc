...
| 284 | nginx login rate limit (zone=login 5r/m, burst=3) blocks agent-testing and bot reconnect login patterns — proposal: burst=10, rate unchanged | KnightOfNight |  |  | 2026-08-22 |
