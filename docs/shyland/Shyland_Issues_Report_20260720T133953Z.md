...
| 30 | Travel network: should checkpoints (shards) also be travel senders? | KnightOfNight | B4 |  | 2026-07-19 |
...
| 38 | Obelisk attunement: player-set home spawn at checkpoint shards | KnightOfNight | B4 |  | 2026-07-19 |
...
| 120 | add version number of running game to 'help' output using key/value display type 1 | KnightOfNight |  |  | 2026-07-20 |
| 123 | Item listing fixes | KnightOfNight | B2 | Version 22 | 2026-07-20 |
| 124 | color fixes | KnightOfNight | B2 | Version 22 | 2026-07-20 |
...
- Milestone: none
- Assignees: none
- Created: 2026-07-19 | Updated: 2026-07-20
- Blocked by: none
- Blocks: none
...
newline separated at the bottom of the current help content, and always remaining the last thing in the help output, and always newline sep from any content above it

### Comments (0)

None.

## Issue #123: Item listing fixes
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/123

### Body

Vendor list does not need a quantity column. 

Vendor list doesn't need to show durability or bound/unbound, just the rarity

Vendor list slot column should contain the slot the item goes in, if any

Player inventory needs the same slot column fix for unequipped items.
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/124

### Body

alias loot-color as success-color




'Combat has ended' should be success-color.




Remove dead colors: bar-v, bar-a, bar-l, combat (legacy)




Name the combat colors...
...
make error-color the same red as crit-out which is the same as artifact



make epic the same yellow as say-color



loot messages like this one '[09:28:48.73] You loot Insect Carapace Mk 1  [Common, Unbound].' should be loot-color, but they appear to be value-color


other loot message colors are OK as they are
