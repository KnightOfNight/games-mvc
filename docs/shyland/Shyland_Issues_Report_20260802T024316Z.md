...
| 189 | Bare 'loot' behaves like 'loot all' — target becomes optional, defaulting to the sweep | KnightOfNight | triaged, V24 | Version 24.5 | 2026-08-02 |
...
Design session (2026-08-01, Version 24.5): this issue is the **founding ticket of Version 24.5**. Milestone `Version 24.5` created and assigned; branch `version_24_5` cut from main and pushed. GDD §9.1 text and the implementation brief follow on the branch per the ruling above (recorded live 2026-08-01 — no open sub-questions).
