...
|---|---|---|---|---|---|
| 4 | Build Zone: Ashenveil Cathedral (Z02) | KnightOfNight | Z02, V28 |  | 2026-09-07 |
| 5 | Build Zone: The Neon Sprawl (Z03) | KnightOfNight | Z03, V28 |  | 2026-09-07 |
| 6 | Build Zone: The Blasted Flats (Z04) | KnightOfNight | Z04, V32 |  | 2026-09-07 |
| 7 | Build Zone: The Iron Deeps (Z06) | KnightOfNight | Z06, V32 |  | 2026-09-07 |
| 8 | Build Zone: The Pale Shore (Z07) | KnightOfNight | Z07, V33 |  | 2026-09-07 |
| 9 | Build Zone: The Wastelands (Z08) | KnightOfNight | Z08, V34 |  | 2026-09-07 |
| 10 | Transactional email via Postmark (password resets) | KnightOfNight | authentication, V27 |  | 2026-09-07 |
| 11 | Account onboarding via unusable password + reset link (no temp passwords) | KnightOfNight | authentication, V27 |  | 2026-09-07 |
| 12 | Two-factor authentication via TOTP (django-otp) | KnightOfNight | authentication, V27 |  | 2026-09-07 |
| 47 | Right pane: player effects display (sent and received) | KnightOfNight | triaged, output, game-mechanics, V26 |  | 2026-09-11 |
| 148 | Loot-take sentence embeds the listing composition — flag block and double space don't match other item output | KnightOfNight | bug, output, commands, V31 |  | 2026-09-07 |
| 161 | Use shortfall warn lacks context — name the item and the now-empty inventory | KnightOfNight | output, commands, V31 |  | 2026-09-07 |
| 163 | Map: more information — starting with percentage of the current zone explored | KnightOfNight | commands, V29 |  | 2026-09-07 |
| 174 | Admin command: uptime (container uptimes, disk free, reclaimable space) | KnightOfNight | commands, V31 |  | 2026-09-07 |
| 179 | New-zone design rules (collecting issue) | KnightOfNight | V28 |  | 2026-09-11 |
| 182 | Map changes/fixes (collecting issue) | KnightOfNight | V29 |  | 2026-09-07 |
| 191 | MC consumer: command-pattern watcher — mine player behavior for the next heal/loot-shaped improvements | KnightOfNight | monitoring-and-command, V30 |  | 2026-09-07 |
| 209 | Research spike: player info on stat points — discoverability, what each stat controls, spend preview/simulator, and respec | KnightOfNight | commands, V31 |  | 2026-09-07 |
| 214 | Move dev to AWS: prod-mirror instance (different FQDN, shared wildcard cert) + automate/document the prod setup | KnightOfNight | deployments, V27 |  | 2026-09-07 |
| 217 | 'last' should show current location for players who are currently logged in | KnightOfNight | output, commands, V31 |  | 2026-09-07 |
| 219 | In-game release notes: new 'readme' command — format and content TBD | KnightOfNight | commands, V31 |  | 2026-09-07 |
| 220 | Multiplayer combat vs a shared NPC is unmodeled — parallel 1v1 sessions: double NPC damage output, no aggro semantics, kill attribution undefined | KnightOfNight | triaged, game-mechanics, V26 |  | 2026-09-11 |
| 223 | Production uptime monitoring + alerting — detect broken/unreachable including DNS; AWS-native vs AI-agent mechanism TBD | KnightOfNight | deployments, V27 |  | 2026-09-07 |
| 236 | Admin 'wall' command: broadcast to all connected players (pending-restart warning) | KnightOfNight | commands, V31 |  | 2026-09-07 |
| 259 | Sirius: AI felis sapiens companion — callable, may help, gives only when he wants to (unfinished design) | KnightOfNight | monitoring-and-command, V30 |  | 2026-09-11 |
| 263 | Player pets / companions: a general system for player-owned NPC allies (may be AI-driven; Machinist depends on it) | KnightOfNight | monitoring-and-command, V30 |  | 2026-09-07 |
| 265 | AI chat responders for NPCs: agents read the MC stream and answer as NPCs in the world (speech-only actuation) | KnightOfNight | monitoring-and-command, V30 |  | 2026-09-07 |
| 282 | Agent door: 'answer' delivery gate must be per-agent context, not verb-global — sudo answers admins only, Sirius answers anyone | KnightOfNight | monitoring-and-command, V30 |  | 2026-09-07 |
| 283 | NPC first-contact greetings broadcast room-wide in second person — bystanders read the 'you' as addressed to them | KnightOfNight | triaged, output, game-mechanics, V26 |  | 2026-09-11 |
| 297 | Curse system live loop is unbuilt: apply active_curse on equip, unequip handling, seedable curse effects, acquisition + identification paths (needed for new zones; rule with #80) | KnightOfNight | triaged, game-mechanics, V26 |  | 2026-09-14 |
| 316 | plan on adjusting big numbers to use shorthand | KnightOfNight | triaged, output, game-mechanics, V26 |  | 2026-09-11 |
| 329 | MC agent process supervision: auto-restart, boot persistence, hang detection | KnightOfNight | monitoring-and-command, V30 |  | 2026-09-07 |
| 330 | Curse engine: schema, apply loop, lifecycle, families, seed set — acquisition admin-only (Release A of the #297 arc) | KnightOfNight | triaged, game-mechanics, V26 | Version 26.2 | 2026-09-14 |
| 331 | Tick engine Phase 1: stacked same-character effects compute from stale per-row snapshots (duplicate arrival lines, last-writer-wins application) | KnightOfNight | bug, triaged, V26 | Version 26.2 | 2026-09-14 |
| 333 | Acuity math deep dive: audit every acuity computation for decimal-precision assumptions and rule one precision doctrine | KnightOfNight | V26 |  | 2026-09-13 |
...
- Created: 2026-07-11 | Updated: 2026-09-07
- Blocked by: #179
- Blocks: none
...
- State: open
- Author: KnightOfNight
- Labels: triaged, output, game-mechanics, V26
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-07-13 | Updated: 2026-09-11
- Blocked by: none
- Blocks: none
...
**KnightOfNight** — 2026-09-07:
Operator ruling (2026-09-07, ops session — parked-issue Q&A): **joins the game-mechanics group** — label applied.

Rationale: the game-mechanics major (curse live loop #297, first longevity drain #70, effect-tick fixes #145) is what finally puts real effects on players — "there will finally be some mechanics to show." This display is the UI counterpart of that work rather than a standalone parked item. Membership/sequencing within the major is the major's first design session's call, per the v30 model.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — full design pass for the effects display):

- **The pane is inbound only: effects whose target is the player.** "It is things happening to the player." Item curses on the player, DoTs put on them by NPCs, HoTs from a pet, Sirius, or another player — and **self-applied effects included, no special conditional** (a quaffed HoT is happening to the player; the pane is source-blind). An effect the player cast on an enemy never appears. **The issue's original "sent and received" scope is formally narrowed to received-only.**
- **Placement: the middle pane** — the region between the bars pane (top) and the map pane (bottom), where fight info lives. Whether effects sit above, below, or interleaved with the fight scroller inside that pane is brief-time layout detail.
- **Row content:** effect **name + time remaining**, then in smaller font the effect's **component list, comma-separated to start** (a multi-effect curse shows all its teeth). **No-expiry curses show the word "permanent"** as their time value (operator-ruled wording).
- **Presentation:** each row a complete item, alternating row colors, scroll bar when the list outgrows the pane. Color specifics land under the chart-as-license law at brief time; numbers are born in #316 shorthand.
- **Screen readers: the section is text and ships SR-accessible as text** — no companion command (operator-ruled; distinct from the aria-hidden map SVG + `map` command pattern of #163). Implementation requirement for the brief: the effects section's markup must actually expose it to screen readers — it must not inherit the map's `aria-hidden` treatment.
- **Machinery note (from the issue, still true):** needs a structured effect-state message (active effects with magnitude/duration remaining) riding the established delivery pattern; cadence and payload shape at brief time.
- **Sequencing (for the grouping step):** after the mechanics that put real effects on players (#145 tick hygiene, #70 first drain, #330 curse engine) and after-or-with #316 (born in shorthand) — the capstone display of the major.
...
- State: open
- Author: KnightOfNight
- Labels: bug, output, commands, V31
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-07-25 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
- State: open
- Author: KnightOfNight
- Labels: output, commands, V31
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-07-29 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-07-30 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-07-30 | Updated: 2026-09-11
- Blocked by: none
- Blocks: #4, #5, #6, #7, #8, #9
...
**KnightOfNight** — 2026-09-11:
## Rule addition — curse-removal capability (operator-ruled 2026-09-11, V26.0 design session, from the #297 Q3 ruling)

**Every new zone ships its curse-removal specialty.** The V26 curse live loop (#297) makes NPC-only cleansing the sole player-facing remediation for item curses — no potions, no consumables. Cleansing capability lives with NPCs ("healers near the other NPCs"), placed across the world rather than concentrated in one hub, so each new zone's NPC roster must include the specialty — an existing NPC gaining it or a new character carrying it, the zone designer's call, consistent with the service-trio precedent at shards.

Companion work item (V26, not a zone rule): a complete inventory of all current NPCs to decide who cleanses in the shipped world. Working verb: `cleanse` (final grammar at §9.1 chart time). Pricing is tied to the curse itself, not the player. Full ruling set on #297.
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-07-31 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
**KnightOfNight** — 2026-09-07:
Operator ruling (2026-09-07, ops session — parked-issue Q&A): **keeper — and promoted in significance: map fixes are their own major version, sequenced before new zones.**

This umbrella remains the collecting issue for that major's queue; its residents (#163, the unfiled "indicate the way out" entry) become the membership candidates when the maps major's first design session runs. Same ruling ordered the majors leading to zones: commands major comes after new zones.


**KnightOfNight** — 2026-09-07:
Sequencing final (2026-09-07, same ops session — the label pass is the plan of record): the full major queue is now numbered — V26 Game Mechanics, V27 Systems, **V28 new-zones-part-1 (#179 standards + rung 2: Z02 #4, Z03 #5)**, **V29 Maps**, V30 MC Actors, V31 Commands, V32 new-zones-part-2 (rung 3: Z04 #6, Z06 #7), and so on per rung. This supersedes this issue's earlier pre-zones/post-zones placement notes; the labels are queryable ground truth.
...
- State: open
- Author: KnightOfNight
- Labels: monitoring-and-command, V30
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-02 | Updated: 2026-09-07
- Blocked by: #37
- Blocks: none
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-07 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
**KnightOfNight** — 2026-09-07:
Operator ruling (2026-09-07, ops session — parked-issue Q&A): **keeper.**

Bigger ruling made in the same breath: **a commands major will exist** — "we have a lot of command updates," and this spike is the issue that surfaced the need. #209 is a membership candidate for that major; the major's first design session applies the membership label, rules the queue, and settles this issue's sequencing (the earlier "soon after the first new zone releases" comment is superseded to the extent that the commands major's own ordering now governs).
...
- State: open
- Author: KnightOfNight
- Labels: deployments, V27
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-08 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
**KnightOfNight** — 2026-09-07:
Operator ruling (2026-09-07, ops session — major-version planning): **a systems-level major version will exist**, covering the platform/infrastructure lanes: transactional email (#10), onboarding via reset link (#11), TOTP 2FA (#12), the dev-to-AWS migration + prod setup automation (#214), and prod uptime monitoring/alerting (#223). Recorded here as the heaviest member; membership labels, queue order, and the major's slot in the release stream are its first design session's call, per the v30 model.

Same session ordered the rest of the queue: Game Mechanics → Maps → New Zones, with Commands and MC any time after zones; the systems major's slot is unruled.


**KnightOfNight** — 2026-09-07:
Sequencing follow-up (2026-09-07, same ops session): operator rules **the systems major goes any time after the new-zones major** — the "slot unruled" line in the previous comment is resolved to post-zones.


**KnightOfNight** — 2026-09-07:
Sequencing revision (2026-09-07, same ops session): operator changes the ruling — **the systems major goes BEFORE the new-zones major**, superseding the post-zones placement in the previous comment. The pre-zones queue is therefore Game Mechanics, Maps, and Systems (relative order among the three not further pinned); Commands and MC remain any time after zones.
...
- State: open
- Author: KnightOfNight
- Labels: triaged, game-mechanics, V26
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-08 | Updated: 2026-09-11
- Blocked by: none
- Blocks: none
...
**KnightOfNight** — 2026-09-10:
Design ruling (2026-09-10, V26.0 design session — Q1 of the #220 question set): **shared session.**

When a player engages an NPC already in combat with another player, they **join that fight's existing `CombatSession`** — one fight, one initiative order, one round stream. This finishes the road the M2M was built for (GDD §5: "the session model is future-ready for group combat") and structurally eliminates the #218 orphan class (parallel sessions can no longer disagree about shared NPC state — there is only one session).

Ruled consequences, part of Q1:

- **Focus becomes per-participant.** `CombatSession.focus_npc` is a session field today; in a shared session each player holds their own focus (and their own Acuity single-target bonus). Storage location (membership row vs. character) is the implementation brief's call.
- **Initiative:** one order rolled per round for all participants (`d10 + DEX + PER`, unchanged). **Player-vs-NPC ties still go to the player(s)** (existing law). **Player-vs-player ties are broken by a fresh random roll among the tied players, re-rolled each occurrence** — no standing advantage (earlier-joiner-first was considered and rejected as unfair given non-trivial tie odds; the extra roll is compute-free at the tick engine's scale).
- **Mid-fight joiners** act on their engagement (their `kill`/`attack` is their first action) and enter the normal initiative order from the next round.
- **NPC output model (confirmed arithmetic, operator-verified in-session):** a shared-session NPC has exactly one attack stream — one attack per round for the whole fight, directed at its aggro target (Q2's subject). Nothing is multiplied per participant as it is today. In the theoretical fight where players deal no damage, the NPC's fight-total output equals a solo fight's, all of it landing on the aggro holder; in real fights the second damage stream shortens the fight and thereby trims the NPC's fight-total output.
- **Accepted consequence, recorded deliberately: no NPC scaling by participant count** in this first model — group play is strictly safer and faster per player (combined incoming damage at solo level, shared HP pool dying faster). #102's aggro-elite room ratings stay untouched.
- **Scope boundary (Q5, restated here as a constraint on Q1's machinery):** solo combat stays byte-identical — the shared-session machinery must be invisible when a session holds one player.

Q2 (NPC aggro/target selection), Q3+Q6a (attribution and corpse rights), Q4 (messaging), Q5 (formal ruling), and Q6b–d (plunder in shared fights) remain open; rulings to follow in this session.


**KnightOfNight** — 2026-09-10:
Design ruling (2026-09-10, V26.0 design session — Q2 of the #220 question set): **NPC targeting is most-recent-damager with stickiness.**

Each round, the NPC's single attack (per Q1: one attack stream, never multiplied) targets its current aggro holder. Aggro rules:

- **The NPC keeps its current target until a different player lands damage on it** — landed damage moves aggro to the damager; misses never move aggro. "Stealing aggro" is thereby a real, intuitive lever: hit the monster and it turns on you.
- **Initial target:** the player the NPC first engaged (the player it aggro'd on at room entry/spawn, or the player who attacked it).
- **If the aggro holder leaves the fight** (flee, death — quit alone does not leave the fight, per the state-gating matrix), aggro falls to the most recent remaining damager; engagement order is the fallback when no remaining participant has damaged it.
- **No threat table, no attention-splitting, no taunt mechanics** — cumulative-threat and random/rotating targeting were considered and rejected (threat tables have no consumer until Archetype abilities exist; random targeting wastes the tactical lever). One target reference per NPC is the whole state.
- Per Q5's boundary: none of this machinery is observable when the session holds one player — solo combat byte-identical.

Q3+Q6a (attribution and corpse rights), Q4 (messaging), Q5 (formal ruling), and Q6b–d (plunder) remain open.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q3 of the #220 question set, incorporating Q6a): **attribution on shared kills is damage-share for the numbers, participant rights for the items.**

- **Q3a — XP: damage-share.** Each participant's XP is proportional to their share of total damage dealt to the NPC; minimum 1 XP for any participant who dealt damage. Rounding scheme is the implementation brief's call. (Full-XP-to-all was rejected as an XP-doubling farm; killing-blow-takes-all rejected as punishing the partner.) The kill's total XP is constant regardless of participant count — exploit-neutral by construction.
- **Q3b — Currency: damage-share, same proportions as XP**, with remainder copper going to the killing-blow player.
- **Q3c — Corpse item rights (the Q6a premise): every fight participant holds loot rights on the corpse.** Normal pickup rules, first-come-first-served — the system assumes players agree among themselves who takes what (operator premise, stated 2026-09-08). This extends §5's "only the killing character may loot" to the participant set on shared kills, and is the premise that makes the plunder questions (Q6b–d) real: plunder sweeps exactly what its owner has rights to.
- **Participant definition (all three parts hang on it):** a character who is a member of the combat session **at the moment the NPC dies**. **Flee forfeits** (XP, currency, corpse rights — the fled character left the session). **Death forfeits** (a dying character left the session). **Quit alone does not forfeit** — quit doesn't leave the fight, per the state-gating matrix.

Q4 (messaging), Q5 (formal ruling), and Q6b–d (plunder in shared fights) remain open.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q4 of the #220 question set): **shared-fight messaging structure ruled in five parts.**

- **Q4a — Own lines unchanged:** a participant's own attacks, the NPC's attacks on them, and their wound-state reads are byte-identical to solo output.
- **Q4b — Partner actions render as attributed third-person narration:** partner blows, misses, and the NPC's attacks on the partner appear as narration lines naming them ("Harley Stone strikes the black bear." / "The black bear claws at Harley Stone."), carried at the fight's normal cadence — one line per action, same round rhythm, one coherent stream.
- **Q4c — Join/leave events announced to all participants:** joining the fight, flee, and death are always visible to every participant (room-visible forms already exist for some; the ruling is that participants always see them).
- **Q4d — The kill is one line naming the killer**, followed by each participant's own attribution output (their Q3 XP/currency share). The solo kill line stays byte-identical when a lone killer fights.
- **Q4e — Aggro movement announces itself:** one line to each participant when aggro moves (e.g. "The black bear turns on you!" / "The black bear turns its attention to Harley Stone."). Holding aggro announces nothing — the #133 no-op doctrine applies. An invisible lever isn't a lever; this makes Q2's mechanic playable.

Exact wording, colors, category assignments, and pool authoring happen at the release's own design/brief time under the pooled-speech and color-doctrine laws — this ruling fixes the structure: what renders, to whom, when.

Q5 (formal scope-boundary ruling) and Q6b–d (plunder in shared fights) remain open.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q5 of the #220 question set): **solo combat stays byte-identical — ruled as formal law binding the implementation.**

- A session holding one player behaves, computes, and renders exactly as today — same rolls, same lines, same bytes. The solo experience (#89/#101/#180 lineage) must not shift by a single character of output or a single point of math.
- All shared-fight machinery — aggro, per-participant focus storage, damage tallies, the player-tie roll, partner narration, join/leave announcements, aggro-movement lines, attribution splits, plunder-conflict logic — must be **structurally invisible** at participant count 1: unreachable or provably identity-preserving, not merely "usually silent."
- Verification shape for the implementation brief: the existing solo combat suite passes unedited, plus explicit byte-identity assertions on representative solo transcripts (the v24.29 "existing suite unedited" regression-bar pattern).
- **Deliberate edge, ruled with it:** a fight that *shrank* to one player (partners fled/died) continues under shared-session bookkeeping — the survivor's attribution share still reflects departed players' damage into the shared HP pool. Byte-identical applies to fights that were solo **throughout**, not fights that shrank to one.

Q6b–d (plunder in shared fights) remain open — the last of the set.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q6, final item of the #220 question set): **plunder never fires on a shared kill — looting is forcefully fair, at least at first.**

Operator-posited rule, superseding the earlier Q6b/c/d option structure (auto-take on mixed settings, conflict auto-suspend, per-fight kill-switch command — all three are dead; none ships):

- **In any fight with more than one participant at the moment of NPC death, plunder is ignored — regardless of any participant's setting.** No auto-sweep fires for anyone. Every participant loots manually on equal footing and the group sorts out who takes what (the Q3c/Q6a agreement premise).
- **No setting is ever toggled.** `Character.plunder_mode` stays exactly as each player set it — the player has it set the desired way; the system simply doesn't act on it here.
- **Per-corpse exemption (operator-confirmed option 1):** a corpse born of a shared kill — more than one rights-holder — is **plunder-exempt for its entire life**. No plunder sweep ever touches it: not at the shared fight's end, and not at any *later* fight-end sweep in the same room (plunder's room-wide "Combat has ended" trigger would otherwise hoover the shared corpse inside the decay window via a subsequent solo kill). Manual `loot` is the only way into a multi-rights corpse. The airtight statement: **plunder never takes from a multi-rights corpse.**
- **Composition with Q3's participant definition:** a fight that shrank to one player before the death (partners fled/died — both forfeit) has exactly one participant at death, hence one rights-holder — a single-rights corpse, and the survivor's plunder fires normally. Plunder operates precisely when no fairness question can exist.
- **Solo fights are untouched** (Q5): single participant → single-rights corpse → plunder behavior byte-identical to today.
- **"At least at first" recorded deliberately:** this is the intentionally simple first model. Future refinement (e.g. an opt-in group-loot arrangement) may revisit it without prejudice; nothing in this ruling forecloses that.

This closes the #220 question set: Q1 shared session · Q2 most-recent-damager aggro · Q3+Q6a damage-share attribution and participant corpse rights · Q4 messaging structure · Q5 solo byte-identical law · Q6 plunder ignored on shared kills.
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-09 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-12 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-16 | Updated: 2026-09-11
- Blocked by: none
- Blocks: none
...
**KnightOfNight** — 2026-09-11:
Cross-ref (2026-09-11, V26.0 design session): the #297 Q3 ruling names Sirius a curse-cleanser — **Sirius will be able to cleanse item curses, if he wants to** (operator-ruled), consistent with his gives-only-when-he-wants-to character. NPC-only cleansing is the sole remediation path for item curses; other AI-driven NPCs may join him. Design details live on #297.


**KnightOfNight** — 2026-09-11:
Lore ruling (2026-09-11, V26.0 design session — operator-directed, from the #297 Q6 discussion): **Sirius smells curses.**

Canonical: Sirius can detect a latent curse on an item by smell — and when he does, **his nose twitches**. Whether he tells anyone what he smelled is, as always, entirely up to him (gives only when he wants to). This is the feline counterpart to his #297-Q3 cleansing capability: he can smell it, he can cleanse it, and he may do neither.

Design boundary carried from #297 Q6: V26 ships **no** player-facing pre-equip curse detection — Sirius's nose is deliberately outside that rule as a someday whim-gated exception in his own lane (this issue), not a service players can rely on or purchase. When Sirius ships, a twitching nose near a cursed item is lore-true ambient theater whether or not he says a word.
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-16 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-22 | Updated: 2026-09-07
- Blocked by: none
- Blocks: none
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-22 | Updated: 2026-09-11
- Blocked by: none
- Blocks: none
...
**KnightOfNight** — 2026-09-07:
Operator ruling (2026-09-07, ops session — major-version planning): **joins the game-mechanics group** — label applied. Membership/sequencing within the major is its first design session's call, per the v30 model.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — operator-confirmed: "option 1 is perfect"): **greetings anchor their addressee by name.**

- **The fix:** first-contact greeting pools are re-authored so every line names its target — `Innkeeper: Welcome to Fordwatch, Sharon-Love — you look road-worn.` Second person stays legal once the name anchors it. The composer path fills a name slot at delivery; the delivery machinery itself (pending-dialogue → tick engine → `broadcast_to_room`) is untouched.
- **Why this shape:** DD §13's room-audible NPC speech doctrine stays intact — every bystander hears the same true dialogue a real room would carry, and the named anchor tells them exactly who is being addressed. Per-recipient split rendering (rejected) would have turned real dialogue into narration summary for bystanders, against the speech/narration attribution rules; perspective-neutral re-authoring (rejected) sands the personality off every greeting in the game.
- **The authoring law, ruled with it (joins the pooled-speech law):** any pooled speech line addressed to a specific player must carry the name anchor. Future pools — shard moods, boss theater, Z02+ zone content — are born correct under it.
- **Scope:** small release — name-slot substitution in the greeting composer path, re-authoring of the existing Z01/Z05 first-contact pools (creative content flows freely at brief time), no migration expected (placeholder convention is a brief-time detail).
...
**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q1 of the #297 question set): **curse identity is an FK on the ItemInstance, rolled at generation from a per-definition candidate pool.**

- **Identity:** a new nullable FK on `ItemInstance` → the curse's `EffectDefinition`, assigned at generation time when the instance rolls cursed. `active_curse` remains what it is today — the *live* `EffectInstance` once the curse has been applied on equip; the new FK is the latent identity that says which curse springs when it does.
- **Variation model (operator-stated):** no infinite curse list, but variation is wanted. The candidate pool lives at the definition/context level: **low-level items of the same make/model/zone all carry the same curse** (pool of one); **high-level items may carry one of several, ranging from very bad to very very bad** — pool size and severity spread grow with item tier. This deliberately expands lore options: a curse can be the signature of a make or a place at low tiers, and a gamble of unknown depth at high tiers.
- Exact pool mechanism (e.g. an M2M of candidate curses on `ItemDefinition`, weighting, tier scaling of severity) is shaped at brief time within this ruling; the fixed points are: identity on the instance, candidates authored per definition/context, roll happens once at generation, one curse per item.

Q2 (apply loop), Q3 (unequip/removal), Q4 (seeded curse families), Q5 (acquisition), Q6 (identification), Q7 (scope/split) remain open.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q2 of the #297 question set): **the apply loop, curse lifecycle, and curse families** (operator-ruled in six parts; this also pre-answers most of Q4's families question).

1. **Duration is a property of the curse itself.** Some curses expire on their own — low-level items carry simple, short-lived curses so players experience the system "nicely" at first. High-level curses have no expiry and require remediation, and the quality of the cursed item is what makes remediation worth it. Authored per curse `EffectDefinition`.
2. **Immediate application.** The curse takes effect the moment the item is equipped. The equip is never refused for being cursed, and soulbind fires as normal — equipping a cursed item is also a permanent bind. The trap functioning is the design.
3. **A curse ends once, and the item comes out clean.** On any curse end, the item is no longer cursed: `is_cursed` clears, the player equips/unequips at leisure, and no re-equip ever re-applies it — one curse life per instance. The item's description updates to memorialize the prior curse (lore stays fun; the item remembers). **Simple rule (operator-confirmed): every end-of-curse cleans the instance, whatever the cause** — expiry, remediation, curse-caused death, or admin teardown (v25.7's sudo unequip/removal already ends the live effect; under this ruling it now also cleans the latent flag).
4. **The apply text is the curse's own lore.** Per-curse authored content, not a generic pool — one vivid line up to a full paragraph, including vision theater ("carried to another world for a vision," returned feeling tired). The machinery must support multi-line apply sequences; content authors freely at brief/seed time under the creative-content policy.
5. **Curse families:** flat stat cuts (e.g. a straight 50% cut to vitality or strength), damage-output or armor-value reduction, over-time drains, and combinations. Two signature DoT shapes ruled by example: **DoT-to-death** — it kills you, the curse ends, and the item is yours to keep forever sans curse (trial by ordeal); **the floor-hold** — drains to almost dead and pins there, never letting the player heal above the hold.
6. **Death semantics — the source is the controlling factor.** Curse-caused death ends the curse (item clean, per rule 3). Death by any other cause: the curse persists — the item is still equipped and still cursed through respawn. General law: a curse lives exactly as long as its source does — item-borne curses while the item bears them; deliberately leaves room for player-applied curses by other means someday, governing their own persistence.

Q3 (remediation path), Q4 (seed set — count/severity tiers; families ruled above), Q5 (acquisition), Q6 (identification), Q7 (scope/split) remain open.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q3 of the #297 question set): **remediation is NPC-only cleansing, world-wide, priced by the curse itself.**

1. **Curse-removal NPCs are part of the design.** Maybe existing NPCs gain the specialty, maybe new people — deciding requires a **complete inventory of all current NPCs** (a work item for the release's brief). The specialty is also a standing requirement for new zones going forward — recorded on #179 as a zone-design standard in the same motion as this ruling, so every zone built under the standards ships its curse-removal capability.
2. **Only an NPC can cleanse — never a potion or consumable.** This is high-level stuff, not something cured from the inventory. **Sirius will be able to cleanse, if he wants to** (in character per #259 — gives only when he wants to; cross-ref recorded there); other AI-driven NPCs maybe.
3. **Not just the Convergence.** Healers near the other NPCs — cleansing capability is placed across the world via the point-1 inventory, not concentrated at a single pilgrimage point.
4. **Price is tied to the curse itself** (operator-confirmed) — not the player's level, not who's asking. Deliberate consequence: a high-level player clearing a low-level item's simple curse pays pocket change; a low-level player who greedily equipped a high-level item faces a removal price potentially far beyond their means — the pricing prices out the failure mode of wearing items far above your station, making the gamble's true cost visible in copper. Exact curve at brief/seed time. **Working verb: `cleanse`** — final grammar and chart entry at §9.1 time.
5. **Cleansing works on active curses only** — a curse live on an equipped item. No pre-equip defusing of latent curses (that would gut the trap); expiring low-level curses may be cleansed early rather than waited out. Per Q2.3, a successful cleanse ends the curse and the item comes out clean forever.

Q4 (seed set — count/severity tiers; families ruled in Q2), Q5 (acquisition), Q6 (identification), Q7 (scope/split) remain open.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q4 and Q5 of the #297 question set): **curses go live in Zone 1, with a seed set of five real curses plus high-tier test curses.**

**Q5 — Acquisition: Z01, fully live.** Curses, curse-removing NPCs, and everything in the loop ship into Zone 1 (The Verdant Reach) — a modest generation-time curse chance on selected Z01-tier item definitions (`is_cursed_template` earning its keep), carrying the simple, expiring, low-level curses: the "nice first experience," live where players actually play. Roll rate, definition selection, and any rarity gating at brief time. Z02+ introduces the no-expiry, remediation-required tier as zone content under the #179 standards (V28).

**Operator direction, recorded here because it was stated here but it scopes the whole major: ALL new V26 features — especially the missing game mechanics — go into Zone 1.** V26 retrofits Z01 with the mechanics as they ship; new zones later build on a world where the mechanics already run.

**Q4 — Seed set: five real curses for Z01** (operator-ruled count), covering the Q2 families at the expiring tier — flat stat cut, short DoT, damage-or-armor reduction, combinations as the set allows — each with its own authored apply-lore (Q2.4), assigned per-definition per Q1's low-level rule (same make/model/zone → same curse). **Plus some high-level ones for testing:** authored and seeded but unreachable in live generation — admin gifting and testing only, until Z02 gives them a habitat. All creative content (names, lore, apply theater) authors freely at brief/seed time under the creative-content policy.

Q6 (identification) and Q7 (scope/split) remain open.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q6 of the #297 question set): **springing the trap is the identification; equipping is the only way to find a curse.**

- **Q6a — Equip identifies.** Equipping a cursed item sets `curse_identified` in the same motion as the apply — the curse's own lore text (Q2.4) *is* the knowledge. From then on `examine` shows the curse detail per the standing display law (`is_cursed AND curse_identified`); once the curse ends, Q2.3's memorialized description takes over the storytelling.
- **Q6b — No pre-equip detection in V26 (operator-ruled: "the only way to find a curse is to equip the item").** Nothing reveals a latent curse before it springs — no divination service, no detection fee at the cleanse NPCs, no skill. Same argument as Q3's no-pre-equip-cleansing, one step earlier: cheap universal detection means nobody ever springs the trap, and the gamble *is* the system. Z01's expiring curses are deliberately safe to learn on.
- **The one someday-exception lives in Sirius's lane, not this system:** Sirius smells curses — nose twitch canonical, telling anyone strictly his whim (recorded on #259). Not a service, not purchasable, not a V26 mechanic.

Q7 (scope/split) is the last open item of the #297 set.


**KnightOfNight** — 2026-09-11:
Design note (2026-09-11, V26.0 design session — operator-directed amendment to the Q6 ruling, for the cleanse release's design): **the NPCs that remove curses can also identify them — at presence level.**

A cleanse-capable NPC can tell the **owner** that an item they are **carrying** is cursed or not, and **which item it is**. This is presence-level knowledge only: it does not reveal what the curse does, and it does not set `curse_identified` — the full knowledge of a curse still comes only from springing it (Q6a). The Q6b law is therefore refined:

- **Equipping remains the only way to learn what a curse *does*.**
- **The cleanse NPCs are the one sanctioned way to learn that a carried item *is* cursed** before wearing it — a service of the same professionals who remove them, not a general divination market.
- Sirius's nose stays outside both rules, whim-gated, in his own lane (#259).

**Shape (operator-ruled):** a **separate purchase** from cleansing — the player pays for a sweep of everything they carry: "look at all my stuff, is it OK?" One transaction, whole carried inventory, answer names which item(s) are cursed (or gives the all-clear). Pricing, verb/grammar (§9.1), and output wording are the cleanse release's design/brief-time work, under this note.


**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — Q7, closing the #297 question set): **the curse arc ships as two releases (operator-confirmed A/B split — "definitely larger than a single release").**

- **Release A — the curse engine — founds on #330** (filed this session): schema, apply loop, full lifecycle, curse families, identification-on-equip, memorial descriptions, the five real Z01 curses plus high-tier test curses seeded — with acquisition staying **admin-only** (gift via the shell helper). Fully playtestable end to end; nothing live-drops yet.
- **Release B — curses in the world — founds on this issue (#297)**: the `cleanse` service (curse-tied pricing, NPC inventory of the shipped world, cleanser placement near the other NPCs), the separate-purchase presence-detection sweep ("look at all my stuff, is it OK?"), and live generation-time acquisition in Z01. Cleansing arrives in the same release that makes curses catchable — no window where a player can catch what no one can remove. **#297 closes when its full title is true: curses work, in the world.**
- Sequencing of the two releases within the V26 stream is the session's grouping step (to follow); A strictly precedes B.

The #297 question set is complete: Q1 curse identity (instance FK, per-definition pools) · Q2 apply loop, lifecycle, families · Q3 NPC-only cleansing, world-wide, curse-tied pricing · Q4 five real + test curses · Q5 live in Z01 (with the major-wide direction: ALL V26 mechanics go into Zone 1) · Q6 equip-identifies, presence-detection as the cleansers' separate purchase · Q7 this split. Related recordings: #179 (new-zone cleanser standard), #259 (Sirius cleanses if he wants; smells curses, nose twitch canonical), #330 (Release A scope).


**KnightOfNight** — 2026-09-14:
Design note (2026-09-14, V26.2 design session — ground-truth finding for Release B): **under the ruled Rare-and-up curse gate (#330 item 6b), only the Viridian Ridge bosses can produce curseable drops in Z01 as seeded today.** The chapter-1 boss tables (`matron-loot`, `whistler-loot`, `dronemother-loot`) roll `uncommon: 100`; the Ridge tables roll Rare+ (`weaver-loot`/`king-loot` `rare: 100`, `devourer-loot` `epic: 100`) — verified in `seed_world.py` (`_seed_verdant_loot_tables` / `_seed_ridge_loot_tables`). V26.2's pools are therefore assigned to the Ridge-boss loot definitions.

Consequence for this issue (Release B): when the live generation chance is wired, curses will drop only from Ridge bosses — chapter-1 bosses never. Coherent as progression (curses begin in the zone's later chapters, where the player is stronger and the "nice first experience" curses are affordable lessons), but it is a fact the Release B design session should consciously bless or adjust (e.g. by touching chapter-1 rarity weights) when ruling the live roll rate.
...
- Milestone: none
- Assignees: KnightOfNight
- Created: 2026-08-30 | Updated: 2026-09-11
- Blocked by: none
- Blocks: none
...
**KnightOfNight** — 2026-09-11:
Design ruling (2026-09-11, V26.0 design session — operator-confirmed): **big-number shorthand, first pass scoped to the fuel-tank bars.**

- **Format (from the issue body, now ruled):** `<1000` → whole number; `≥1000` → one-decimal K; `≥1,000,000` → one-decimal M. Examples of record: `26.5K / 26.5K`, `15.7K / 26.5K`, `315 / 26.5K`.
- **Pinned invariant:** formatted current never reads above formatted max (no `27.0K / 26.9K` from rounding). Exact rounding mode and boundary cases (999,950-style) are brief-time details under that invariant, pinned by tests.
- **Scope, first pass: one shared formatter applied to Vitality and Longevity current/max everywhere they render** — stats pane, status text output, anywhere a bar prints. Deliberately excluded: **currency** (the copper tier formatter — silver/gold/platinum — IS its shorthand system, and every player-facing amount goes through it by law); **Acuity** (0.1–1.9 float, never big); **combat damage numbers** (a separate legibility call for a later ruling when numbers get there). The shared helper makes each later adoption a one-line change — the issue's "plan on adjusting" framing honored.
- **Sequencing (for the grouping step): lands before or with #47** — the effects pane is born displaying shorthand, never retrofitted.
- **Scope:** one small release, one brief, code-only — formatter helper + adoption at the bar render sites; no migration, no seed. Client/server formatting split is a brief-time implementation detail; the status payload keeps raw numbers for bar-fill math either way.


## Issue #329: MC agent process supervision: auto-restart, boot persistence, hang detection
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/329

### Body

## Summary

Process supervision proper for the MC agent fleet: **auto-restart on crash, boot persistence, hang detection** — the remainder deliberately deferred out of the v1 runtime shape (#268, operator-ruled 2026-08-23: "operator starts it, any shell can inspect/restart it, and the kill switch (#266) remains the always-working safety backstop").

Extracted into its own ticket 2026-09-07 (ops session, operator-directed) so the #268 runtime arc could close: this was the arc's only work item not filed anywhere else.

## Context

- v1 posture (shipped across the V25 era): bots are standalone detached processes on the bot host, managed via botctl (start/stop/status, per-(bot, target) singleton per #304/#299), supervised by hand — any shell, including a CC session over Remote Control, is the inspection/restart surface.
- That posture tolerates one bot (sudo). The V30 MC Actors major (Sirius #259, pets #263, NPC responders #265) grows the fleet — a dead player-facing bot is a visibly broken game object, not a quiet admin tool, and hand-supervision stops scaling.
- A dead/hung agent must be noticed by monitoring, not by a player wondering why the innkeeper went quiet (#268's framing).

## Open questions for the design session

- Mechanism: OS-level service management on the bot host vs. a supervisor process vs. something else — and how it composes with botctl's pidfile/singleton model.
- Hang detection: what "alive" means for a bot (socket connected? recent stream reads? heartbeat?), and what a supervisor may safely do about a wedged process.
- Boot persistence: whether bots belong in the host's boot sequence at all, per target (dev vs prod attach discipline).
- Failure legibility: how a restart/flap is surfaced to the operator (log-only, or an alerting hook alongside #223).

Refs: #268 (the closed runtime arc and its rulings), #266 (kill switch — the standing backstop this never replaces), #259/#263/#265 (the fleet that makes it necessary).
...
## Issue #330: Curse engine: schema, apply loop, lifecycle, families, seed set — acquisition admin-only (Release A of the #297 arc)

- State: open
- Author: KnightOfNight
- Labels: triaged, game-mechanics, V26
- Milestone: Version 26.2
- Assignees: KnightOfNight
- Created: 2026-09-11 | Updated: 2026-09-14
- Blocked by: #331
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/330

### Body

## Scope — Release A of the #297 curse arc (operator-ruled A/B split, 2026-09-11, V26.0 design session)

The curse engine, complete and playtestable end to end, with acquisition staying **admin-only** (gift via the shell helper). The world half — the `cleanse` service, the paid presence-detection sweep, the NPC inventory/placement, and live Z01 generation — is Release B, founded by #297 itself, which closes only when curses fully work in the world.

### In scope (per the #297 ruling set — Q1–Q6 recorded there 2026-09-11)

- **Schema:** curse-identity FK on `ItemInstance` → curse `EffectDefinition` (rolled at generation from a per-definition candidate pool; pool mechanism at brief time); memorial-description support; whatever duration plumbing expiring curses need.
- **Apply loop:** curse applies the moment a cursed item is equipped (equip never refused; soulbind fires as normal — a cursed equip is a permanent bind); `active_curse` populated; `curse_identified` set in the same motion (springing the trap IS the identification); multi-line apply theater support (per-curse authored lore, up to vision sequences).
- **Lifecycle:** duration is a curse property (expiring low-level vs. no-expiry high-level); every end-of-curse cleans the instance whatever the cause (expiry, curse-caused death, admin teardown — and cleansing when Release B ships it): `is_cursed` clears, item freely usable, no re-application ever, description memorializes the prior curse.
- **Death semantics:** curse-caused death ends the curse (item clean, yours to keep); death by other causes leaves the curse standing through respawn. The source is the controlling factor.
- **Curse families:** flat stat cuts (e.g. 50% vitality or strength), damage-output/armor-value reduction, over-time drains, combinations; the two signature DoT shapes — DoT-to-death (trial by ordeal) and the floor-hold (pins near-dead, blocks healing above the hold).
- **Seed:** five real expiring-tier curses for Z01 (assigned per-definition: same make/model/zone → same curse) plus high-tier test curses unreachable in live generation; all creative content (names, lore, apply theater) authored at brief/seed time under the creative-content policy.
- **Solo/display laws intact:** curse hidden everywhere except `examine` under `is_cursed AND curse_identified`; v25.7 sudo surfaces keep working (teardown now also cleans the latent flag).

### Out of scope (Release B — #297)

Live generation-time acquisition in Z01, the `cleanse` verb/service and its curse-tied pricing, the paid "look at all my stuff, is it OK?" detection sweep, the complete NPC inventory and cleanser placement (#179 carries the new-zone standard; #259 carries Sirius's whim-gated nose).

Full design record: the Q1–Q7 ruling comments on #297.


### Comments (5)

**KnightOfNight** — 2026-09-14:
Design ruling (2026-09-14, V26.2 design session — schema item of the #330 shape set; operator confirmed all four):

- **2a — The latent-identity FK is `ItemInstance.latent_curse`** — nullable FK → `EffectDefinition`, holding which curse springs on equip. Reads correctly against `active_curse` (the live `EffectInstance` once sprung), per the #297 Q1 identity ruling.
- **2b — The candidate pool is a through-model: `CurseCandidate`** (FK item definition, FK curse effect definition, integer `weight` default 1). Weight ships now: low-level pools of one don't care, but the ruled high-tier "one of several, very bad to very very bad" spread wants the very-very-bad rarer — adding weight later would be a mid-arc migration.
- **2c — Release A ships the full generation-time roll machinery; the wild chance stays dormant.** `generate_item_instance` gains an explicit `force_curse=True` parameter (rolls `latent_curse` from the definition's pool, sets `is_cursed`) — the shell-helper gifting path uses it, making A fully end-to-end testable through the same code path Release B will use. The natural roll (ordinary drops, gated on `is_cursed_template`) ships wired but with no live chance until Release B (#297) turns it on. Zero wild drops in A.
- **2d — Curse-ness is a new boolean `EffectDefinition.is_curse`.** Authored curse definitions are built from *real* components (dots, stat penalties, the new family types); the apply loop and pool queries key off the flag. **`curse_generic` is retired from use — its choice row stays** (no data migration risk; nothing seeds it).

Recorded from the in-session Q&A; exact field/migration mechanics land in the V26.2 brief under these fixed points.


**KnightOfNight** — 2026-09-14:
Design ruling (2026-09-14, V26.2 design session — curse-families component machinery, item 3 of the #330 shape set; operator confirmed all five):

- **3a — Percent stat cuts: new component type `stat_cut_percent`** (reuses `target_stat`; magnitude = fraction). The flat delta is computed at apply time and stored on the component instance, so reversal at curse end restores exactly what was taken — no drift if level-ups move the base stat mid-curse.
- **3b — Percent bar cuts ride the bar law.** "A 50% cut to vitality" cuts `vitality_max` (Longevity variant falls out for free; Acuity excluded — band identity, not a fuel tank). New per-bar bar-cut component type; the cut and the restore both go through the standing atomic rescale — fill fraction invariant on apply and on curse end. Nothing refills.
- **3c — Damage-output and armor-value reduction: two new component types** read as multipliers at the two combat read points — one scales down the player's outgoing damage term, one scales down TAV before the armor curve. Multiple actives multiply together. General machinery, curse-only in practice this release.
- **3d — Floor-hold gets a second authored number: `EffectComponent` gains a nullable second magnitude pair** (`magnitude2_base`/`magnitude2_scaling`). Floor-hold uses magnitude = drain per tick, magnitude2 = hold point as fraction of max — "almost dead" is authorable per curse (a crueler curse pins lower), never a global constant. While held: heals cannot raise the bar above the hold, the drain stops at the hold (never takes below), outside damage (combat) still can. Every other component type ignores the second pair.
- **3e — DoT-to-death is NOT a new component type.** It is an authored no-expiry `dot_vitality` inside a curse effect: the existing dot machinery already carries a character to the fall (verified: out-of-combat `dot_vitality` at 0 triggers the standard Dying fall in `process_effects`), the fall is the standard death experience, and "curse-caused death ends the curse" is death-semantics work keying on which effect caused the fall — item 4's lane, not a component.

Recorded from the in-session Q&A; exact type names, migration, and combat read-point wiring land in the V26.2 brief under these fixed points.


**KnightOfNight** — 2026-09-14:
Design ruling (2026-09-14, V26.2 design session — lifecycle plumbing, item 4 of the #330 shape set; operator confirmed all five):

- **4a — No-expiry representation: new boolean `EffectComponent.no_expiry`.** Such components create instances with `expires_at = NULL` (already nullable); the expiry sweep skips them. `duration == 0` keeps meaning instantaneous — no sentinel overloading.
- **4b — One shared teardown for every end-of-curse** — expiry, curse-caused death, admin teardown, Release B cleansing later — with cause-specific `removed_by`. It deactivates the effect + components, reverses every reversible component (stat cuts; bar cuts via the bar-law rescale), clears `is_cursed` AND `latent_curse` (no re-application ever), stamps the memorial (4c), leaves `curse_identified` as-is (historical; display keys on `is_cursed AND curse_identified`). The v25.7 sudo removal path becomes a caller of this function.
- **4c — Memorial mechanics: authored per curse, appended per instance.** New TextField on `EffectDefinition` (memorial text — creative content, authored at seed time); at teardown it is stamped onto a new nullable per-instance field on `ItemInstance`; `get_display_description` appends it as a closing paragraph after the normal description — the item's story grows, the base description isn't replaced.
- **4d — Death-semantics exemption at BOTH cancel sites** (verified: the fall's `fall_and_cancel` and respawn's `execute_death` each cancel all active effects today). Curse-sourced `EffectInstance`s are exempt from both cancels — except the curse whose own component caused the fall, which instead ends through the 4b teardown (curse-caused death: item clean, yours forever). Multiple curses: only the causing curse ends; the others ride through. Non-curse effects cancel exactly as today.
- **4e — A persisting curse never suspends.** Through the dying window and after respawn it keeps running (ticks on an emptied bar are no-ops; max-cuts stay in force — the respawn refill fills to the CUT max). Confirmed deliberate: a DoT-to-death curse surviving a non-curse death resumes draining post-respawn and eventually kills again — that death is curse-caused and frees the item. The ordeal continues until the curse wins once.

Recorded from the in-session Q&A; exact field names, teardown signature, and cancel-site mechanics land in the V26.2 brief under these fixed points.


**KnightOfNight** — 2026-09-14:
Design ruling (2026-09-14, V26.2 design session — apply theater + identification-on-equip, item 5 of the #330 shape set; operator confirmed all five):

- **5a — Theater storage and voice:** new TextField on `EffectDefinition` (apply text, authored freely per curse under the creative-content policy — one vivid line up to a full vision paragraph). Rendering: split on newlines, each non-empty line sent as its own output message in sequence — that is the whole multi-line machinery. Voice: **narration** — value-color, ambient, unattributed, per the color doctrine (the world talking; not chrome, not a combat red).
- **5b — Ordering: the mundane sentence first, then the world turns.** The standard `You equip …` success line prints as normal, THEN the theater lines, then the machinery lands (curse applied, `active_curse` populated, `curse_identified` set in the same motion; soulbind fires as normal, unchanged). The trap springing after the routine action completes is the design beat.
- **5c — The curse applies at the item's `mk_tier`, bypassing every gate.** Curse magnitudes scale with the item via standing `magnitude_scaling` machinery. Curse applications skip BOTH admission checks — the #331 lane gate (Q5 exemption) and the same-definition replace check. Edge made explicit: two cursed items carrying the same curse definition each spring their own independent instance; both run, they join.
- **5d — Private theater only in Release A.** The room sees nothing when someone's curse springs — no broadcast line. (Room-visible texture is a possible Release B+ flourish, not ruled.)
- **5e — Examine's reveal, once identified:** curse name, time remaining ("permanent" for no-expiry — #47's ruled vocabulary), and the curse's authored description. Exact line composition at brief time. (Reveal gate stays `is_cursed AND curse_identified`, verified at consumers.py:1910.)

Recorded from the in-session Q&A; hook placement across the equip paths and exact composition land in the V26.2 brief under these fixed points.


**KnightOfNight** — 2026-09-14:
Design ruling (2026-09-14, V26.2 design session — seed-set structure, item 6 of the #330 shape set, closing it; operator confirmed all, with 6b modified in-session):

- **6a — Family coverage of the five real Z01 curses.** All five expiring-tier and gentle, covering the ruled families: (1) percent stat cut, (2) percent bar cut (vitality max), (3) short DoT, (4) damage-output or armor cut, (5) a combination (two mild components). The two lethal signatures — DoT-to-death and the floor-hold — deliberately do NOT appear at the expiring tier; they are high-level identities and live in the test set.
- **6b (operator-modified) — Curses are limited to the higher-rarity items that bosses drop.** Structurally two conditions: pool membership only on `ItemDefinition`s appearing in **boss/world-boss loot tables** (`npc_type` boss/world_boss → `loot_table` entries), and the curse roll gated on the **rolled instance rarity, floor = Rare** (Rare, Epic, Legendary; operator-confirmed "rare and up"). Definition selection among Z01 boss-loot entries is brief-time work; `is_cursed_template` marks the selected definitions. The admin `force_curse` override deliberately bypasses the rarity gate so playtests can curse anything.
- **6c — The high-tier test set is three curses, gifted by explicit override:** a DoT-to-death, a floor-hold, and a no-expiry multi-component combination. They belong to no definition's pool — unreachable in generation even after Release B wires the live chance (reachable only when Z02+ authors them into pools). Addition to the 2c machinery: the shell-helper force path accepts an explicit curse override (`generate_item_instance(..., force_curse=True, curse=<definition>)`) — pool roll when omitted, named curse when given; also how playtests pin a specific curse.
- **6d — Expiring-tier duration band: single-digit minutes (roughly 3–10 min real time)** — long enough to feel the teeth, short enough to stay the "nice first experience." Exact per-curse numbers at brief/seed time within the band.
- Names, lore, apply theater, and memorial text author freely at brief/seed time under the creative-content policy.

The #330 shape set is complete: item 2 (schema: `latent_curse` FK, `CurseCandidate` through-model with weight, dormant wild roll + `force_curse`, `EffectDefinition.is_curse`, `curse_generic` retired-in-place) · item 3 (families machinery: `stat_cut_percent`, bar cuts on the bar law, damage/armor multipliers, floor-hold with second magnitude pair, DoT-to-death = authored no-expiry dot) · item 4 (lifecycle: `no_expiry`, one shared teardown, authored memorials appended per instance, dual-cancel-site death exemption, curses never suspend) · item 5 (apply theater: newline-split narration after the equip line, item-Mk application bypassing every gate, private-only, examine reveal) · item 6 (this comment). Together with the #331 admission-policy set (Q1–Q7, recorded there), design is complete for the release; GDD text and the brief follow on `version_26_2`.


## Issue #331: Tick engine Phase 1: stacked same-character effects compute from stale per-row snapshots (duplicate arrival lines, last-writer-wins application)

- State: open
- Author: KnightOfNight
- Labels: bug, triaged, V26
- Milestone: Version 26.2
- Assignees: KnightOfNight
- Created: 2026-09-13 | Updated: 2026-09-14
- Blocked by: none
- Blocks: #330
- URL: https://github.com/KnightOfNight/games-mvc/issues/331

### Body

## What happens

Phase 1 component ticking (`run_tick_engine.process_effects`) loads all active ticking `EffectComponentInstance` rows in one query with `select_related` to the target character. Two component instances targeting the same character get **two separate in-memory Character objects** — Django shares no identity across rows. Each branch computes `old`/`new` from its own snapshot, so within a single round boundary:

- **Values (pre-existing, predates v26.0):** the second component's save overwrites the first's — last-writer-wins. Two `dot_vitality` 10s on a 100-Vitality character leave 90, not 80; one application is silently lost. Same shape for every same-bar pairing (dot+dot, hot+hot, dot+hot).
- **Announcements (visible since v26.0, #145):** a second HoT "arrives" at a bar the first already filled in the same tick and prints a terminal line for a delta it never applied. Under the #133/#145 doctrine it should be silent — `new == old` against the character's true state.

The dying path already guards one cross-component case (the `newly_dying` set); the general staleness is unguarded.

## Repro (dev stack, v26.0 build)

Shell-apply two `hot_vitality` component instances to one damaged character, wait one round boundary out of combat: two `Your body is whole once more. (+N Vitality)` lines fire, and the DB reflects a single application's effect.

Found in the V26.0 Brief 1 operator playtest (2026-09-13).

## Operator ruling (2026-09-13, recorded from the in-session conversation)

- A player **can** have multiple HOTs, DOTs, curses, etc.
- They each fire **in the order they were applied**.
- They all work on a **fresh look at the player's data** — stacked effects genuinely stack: multiple HOTs heal faster, multiple DOTs kill faster. (This resolves both halves above: real cumulative application, and genuinely silent no-op ticks.)
- Multiples will always **work** right; the open design question is whether we **allow** them at apply time. Direction sketched: applying a HOT while one is active **fails unless the new one is "better"**; applying a DOT while one is active — a **less bad one fails, a worse one applies**.

The admission policy (definition of "better"/"worse", per-family scope, refusal messaging) needs a design-session ruling. Directly relevant to #330 (curse engine, release 26.2), which builds ticking curse effects on these exact branches.


### Comments (2)

**KnightOfNight** — 2026-09-14:
Design ruling (2026-09-14, V26.2 design session — Q1 of the #331 admission-policy set): **comparison scope confirmed.**

- **Q1a — The gate operates per (direction, bar) lane.** All `hot_vitality` sources compete in one lane, all `dot_vitality` in another, `hot_longevity` in a third, and so on. A DoT never gates a HoT and vice versa (the poison-vs-healing race is legitimate gameplay), and different bars never gate each other.
- **Q1b — First pass gates the six dot/hot lanes only** (3 bars × 2 directions: `dot_vitality`, `hot_vitality`, `dot_longevity`, `hot_longevity`, `dot_acuity`, `hot_acuity`). The other timed families — `shift_acuity_high`/`shift_acuity_low`, `stat_bonus`/`stat_penalty` — keep today's coexist-freely behavior until something proves they need a policy. (`curse_generic` / curse-sourced components are Q5's lane.)

Q2 (better/worse definition), Q3 (join vs replace), Q4 (same-definition refresh rule), Q5 (curse exemption), Q6 (refusal surfacing), Q7 (milestone membership) remain open.


**KnightOfNight** — 2026-09-14:
Design ruling (2026-09-14, V26.2 design session — Q2–Q7, closing the #331 admission-policy set):

- **Q2 — "Better"/"worse" is per-tick magnitude, strict, duration-blind.**
  - **Q2a:** per-tick magnitude is the single comparison axis — legible ("this potion heals harder"), matches how components are authored, no remaining-duration arithmetic the player can't see.
  - **Q2b:** strict inequality both directions — a strictly better HoT admits, a strictly worse DoT admits; an **equal** effect is refused in both directions (no free duration-extension through the side door; same-definition refresh is Q4's lane).
  - **Q2c:** duration plays no role in the comparison — a stronger-but-shorter HoT beats a weaker-but-longer one.
- **Q3 — Admission means JOIN, not replace.** The admitted effect runs alongside the existing one(s); the lane's stack builds by climbing (each new entrant must beat the incumbents per Q2). This is the reading consistent with the base ruling: multiple HoTs heal faster, multiple DoTs kill faster, each firing in apply order against a fresh read.
- **Q4 — The existing same-definition rule stays, checked first.** Re-applying the *same* `EffectDefinition` at ≥ Mk replaces the active instance (refresh + upgrade, `removed_by='reapplication'` as today); lower Mk is refused. The Q1–Q3 lane gate governs **cross-definition** contention only.
- **Q5 — Curses are exempt, both directions.** A curse-sourced component always lands regardless of what's active (equip is never refused; the trap always fires — the #297 Q2 ruling), and a live curse component never blocks an ordinary HoT/DoT from admission into its lane (the floor-hold's pin is its own semantics, not the admission gate's job).
- **Q6 — Refusal surfacing.**
  - **Q6a:** player self-applied refusal (`use` on a not-better consumable) — the consumable is **kept, not spent**, with a warn-layer (world-declined) message naming the stronger effect already running. This deliberately changes today's same-definition lower-Mk path (silently spent) to the same kept-plus-warn treatment.
  - **Q6b:** NPC proc DoT refused (not worse than what's already on you) — **silent**; the attack line simply doesn't name the effect.
- **Q7 — #331 joins the Version 26.2 milestone as a dependency of #330** (blocked-by link recorded) and closes with the release: the staleness fix (fresh-read, apply-order, cumulative application) plus this admission policy are Brief 1 scope — the curse engine's ticking components sit on exactly these branches.

The #331 set is complete: Q1 (per-(direction, bar) lanes; six dot/hot lanes gated, shifts/stat effects free) · Q2 (per-tick magnitude, strict, duration-blind) · Q3 (join) · Q4 (same-definition refresh kept, checked first) · Q5 (curses exempt) · Q6 (kept-plus-warn self-refusal; silent NPC refusal) · Q7 (milestone dependency of #330). Refusal wording and exact mechanics land in the V26.2 brief.


## Issue #333: Acuity math deep dive: audit every acuity computation for decimal-precision assumptions and rule one precision doctrine
...
- Blocked by: none
- Blocks: none
- URL: https://github.com/KnightOfNight/games-mvc/issues/333

### Body

## Why

One playtest (V26.0 Brief 1, 2026-09-13) found two independent decimal-precision defects in a single branch: `hot_acuity` could never arrive at a 2-decimal baseline (1-decimal arrival round), and its mid-walk 1-decimal round erased sub-0.05 magnitudes while truncating Phase 2 drift's 2-decimal progress backwards (#332, both parts fixed in-session on `version_26_0`). The acuity system has accreted three precisions — 1-decimal legacy storage rounds (#133 era), 2-decimal baselines/bands and drift, and the v24.22 two-decimal display doctrine — and nothing guarantees the remaining sites agree.

## The task

A deep dive into **all acuity math everywhere**, auditing every computation, storage round, comparison, and clamp for decimal-precision assumptions, so that all acuity math works for every representable baseline/band/magnitude with no hidden precision coupling. Known sites to cover (not exhaustive — the audit enumerates its own inventory):

- `run_tick_engine.py`: `dot_acuity` (still stores `round(..., 1)`), `hot_acuity` (2-decimal since #332), `shift_acuity_high` / `shift_acuity_low` (1-decimal mid-walk rounds, exact band-edge store on high; low has no exact-store case today), Phase 2 drift (2-decimal, exact snap-to-baseline within `ACUITY_DRIFT_RATE`)
- `combat_utils.py`: `acuity_damage_modifier`, `ACUITY_FLOOR` / `ACUITY_CEILING` clamps and every equality/inequality against them (exact-store values vs rounded values in comparisons)
- `effect_utils.py`: any instant acuity restore/set paths
- `consumers.py`: the stats sheet's acuity render/conversions; `_build_status` payload rounds
- Client: `toFixed(2)` sites (display only — confirm no client-side math)
- Data: `Origin` baselines and band edges (2-decimal by seed), `EffectComponent` magnitudes (arbitrary floats — authored curse/effect magnitudes must all work; #330 builds on these branches)

## Deliverable

A ruled, documented single precision doctrine for acuity (what precision is stored where, which boundaries are exact-store, what comparisons are legal), each violating site fixed to it, and tests pinning the doctrine — including small-magnitude and 2-decimal-baseline cases across every branch, not just `hot_acuity`.

Filed from the V26.0 Brief 1 implementation session at the operator's direction; a corresponding step is added to the brief's playtest checklist exercising the fixed small-magnitude walk.
...
|---|---|---|---|---|
| 70 | Longevity has no drain — the slow-burn design needs its first consuming mechanic | KnightOfNight | triaged, game-mechanics, V26 | 2026-09-13 |
| 332 | hot_acuity 1-decimal rounding can never arrive at 2-decimal baselines: no terminal, endless announce loop fighting drift | KnightOfNight | bug, V26 | 2026-09-13 |
| 145 | hot_acuity / dot_acuity announce no-op effect ticks (doctrine from #133) | KnightOfNight | triaged, game-mechanics, V26 | 2026-09-13 |
| 268 | MC agent runtime & operations: hosting, supervision, credentials, cost governance for the AI actor fleet | KnightOfNight | monitoring-and-command | 2026-09-07 |
| 261 | The Command half of MC: how does a non-human actor take action in the world? (scoping) | KnightOfNight | monitoring-and-command | 2026-09-07 |
| 126 | pluralization subsystem — natural-English plurals for aggregate output | KnightOfNight | output | 2026-09-07 |
| 243 | Deleted-while-connected: commands that never fresh-fetch (e.g. inv) render empty/stale output instead of routing to the creator | KnightOfNight | commands | 2026-09-07 |
| 326 | sudo bot: request failures are silent to the requesting admin — operator wants a legible in-pane line whenever the bot is running | KnightOfNight | triaged, monitoring-and-command | 2026-09-07 |
| 315 | Door durability edit can silently break a non-wearing item: 0 sets is_broken (combat-honored) with no display cue and no in-game repair path | KnightOfNight | triaged, monitoring-and-command | 2026-09-05 |
| 321 | Bulk buy/sell at admin-scale quantities takes minutes with zero output — sell is O(n) transactions, buy O(qty) serial INSERTs | KnightOfNight | triaged, commands | 2026-09-05 |
| 323 | test ticket to verify sudobot can add labels | KnightOfNight | bug, emergent | 2026-09-02 |
| 317 | Sudo bot: file_issue cannot apply labels — extend the filing vocabulary to carry operator-named labels | KnightOfNight | triaged, monitoring-and-command | 2026-09-01 |
| 320 | Agent door / sudo bot has no currency actions — add full copper management (grant and deduct) | KnightOfNight | triaged, monitoring-and-command | 2026-09-01 |
