...
- **U/D badges:** 14px bold `Courier New` text, U at the upper-right corner and D at the lower-right, text centers at (+17, −17) and (+17, +17) from the glyph center (uniform for all glyph shapes). Per-badge color: value-color if the destination room is visited, muted-color if not — independent per direction. (The v20 "UD" composite badge is retired.)
