...
| 279 | MC test-agent client: operator-side script that connects to the egress and tails the event stream (CLI: URL, username, password) | KnightOfNight | monitoring-and-command |  | 2026-08-21 |
