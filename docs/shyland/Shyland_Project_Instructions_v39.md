# Shyland Project Instructions v39

**Status: ACTIVE — approved by the operator 2026-09-14. Supersedes Shyland_Project_Instructions_v38.md.**

These instructions govern every Claude Code session doing Shyland work, of every type. Read them at the start of any Shyland session. **The document's version is an independent counter, decoupled from the game version (operator ruling 2026-07-27):** every refresh that changes process rules produces the next-numbered edition, whenever that happens; the highest-numbered edition is always the active one. This decoupling applies to the instructions doc only — the GDD and architecture doc remain in game-version lockstep. This v39 edition is the three-bars truth pass (cut at the V26.1 closeout, 2026-09-14, on the flag recorded in the V26.1 Brief 1 closeout report): the Three Bars section is updated to shipped reality — Longevity's first drain landed in v26.1 (#70) — and no process rule changes in this edition. (v38 the playtest-format pass — every operator playtest checklist is explicit numbered run/expect/decision sequences, never prose; v37 the daemon-inspection pass; v36 the technical-coherence pass; v35 the action-item pass; v34 the interim-retirement pass; v33 the prod-verification ruling pass; v32 the gift-language pass; v31 the seed-prod pass; v30 the label model; v29 the release model; v28 the playtest-disposition gate; v27 the GDD-errata rule; v26 the end rituals; v25 the closeout session type.)
