...
> Authoritative technical reference as of commit d11b26d (v19 brief 3: NPC attack-perspective fix, engagement/ordinal messaging, and kill/fall broadcast exclusion).
...
Two changes in v18 (brief 3), one in brief 5, three in v19 brief 2, and two in v19 brief 3; everything else *(unchanged from v15)*.
