...
> Authoritative technical reference as of commit 9c10e04 (v19 brief 8: room output, fixtures, and seed authority).
...
Two changes in v18 (brief 3), one in brief 5, three in v19 brief 2, two in v19 brief 3, the fall/dying/expiry rework in v19 brief 4, the focus-driven targeting rework in v19 brief 6, one call-site change in v19 brief 7, and three changes in v19 brief 8 below; everything else *(unchanged from v15)*.
