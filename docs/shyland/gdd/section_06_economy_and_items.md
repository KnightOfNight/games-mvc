...
- **Price is tied to the curse itself, never the player:** the charge is the curse's authored `cleanse_price` × the item's Mk tier. The Z01 expiring tier is pocket change for a Ridge-level player — Curse of the Craven Edge 60 · Curse of the Moth-Eaten Ward 75 · Tithe of the Copper Court 90 · The Whisper in the String 120 copper at Mk 1; the no-expiry tier is deliberately beyond a Z01 purse — The Hollowing 5 gold · Gravekeeper's Hold 8 gold · The Threefold Ruin 15 gold at Mk 1, times Mk — so a low-level player who wears a high-tier item meets the price of that gamble in copper. Once a curse is identified, `examine`'s revealed block shows the cleansing price, tier-formatted.
